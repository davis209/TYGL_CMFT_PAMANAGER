 ...
 * in any form.
 *
 * Source: $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/RegionHelper.cpp $
...
namespace TA_Base_Core
{
    ...
    RegionHelper::RegionHelper(const ta_uint32 key)
        : m_key(key),
          m_name(""),
          m_description(""),
          m_displayName(""),
    ...
    RegionHelper::RegionHelper(const ta_uint32 key, const std::string& name, const std::string& description,
    ...
    RegionHelper::RegionHelper(const ta_uint32 row, TA_Base_Core::IData& data)
        :
        m_key(0),
        m_name(""),
        m_displayName(""),
        ...
        m_isValidData(false)
    {
        FUNCTION_ENTRY("RegionHelper(const ta_uint32 , TA_Base_Core::IData&)");
    ...
    void RegionHelper::reloadUsing(const ta_uint32 row, TA_Base_Core::IData& data)
    {
