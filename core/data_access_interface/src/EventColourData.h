 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/EventColourData.h $
 * @author:  Derrick Liew
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    public:
         ...
         */
        EventColourData(const ta_uint32 key);
         ...
         */
        EventColourData(const ta_uint32 row, TA_Base_Core::IData& data);
         ...
         *            either 0 or 1), or if the wrong amount of data is retrieved.
         */
        ta_uint32 getEventColourKey(EEventColourType type = OPEN_ACKED_FG1);
