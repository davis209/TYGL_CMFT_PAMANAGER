 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/PowerDemandAccessFactory.cpp $
 * @author:  wenching
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    void PowerDemandAccessFactory::getPowerDemandDataPointNames(std::set<std::string>& powerDemandPoints)
    {
        ...
        do
        {
            ...
            {
                LOG_EXCEPTION("DatabaseException", e.what());
    ...
    void PowerDemandAccessFactory::getPowerDemandData(PowerDemandData& powerDemandData)
    {
        ...
        ta_uint32 interval = ((localTime.tm_hour * 60 + localTime.tm_min) / 30) + 1;
        ...
        do
        {
            try
            {
                ta_uint32 recordedValue = 0;
                ta_uint32 updatedValue = 0;
    ...
    void PowerDemandAccessFactory::setPowerDemandData(const PowerDemandData& powerDemandData)
    {
        ...
        LOG_DEBUG("PowerDemandAccessFactory::setPowerDemandData() - sql is %s", strExSql);
