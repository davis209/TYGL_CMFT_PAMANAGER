 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/EquipReport.h $
 * @author:  Ripple
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    public:
        ...
        EquipReport(std::string& key, const std::string& name, const ta_uint32 locationId);
         ...
         */
        EquipReport(const ta_uint32 row, TA_Base_Core::IData& data);
