 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/ScadaDisplayHelper.cpp $
 * @author:  Karen Graham
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    ScadaDisplayHelper::ScadaDisplayHelper(const ta_uint32 key)
        : m_key(key),
          m_name(""),
          m_path(""),
          m_location(0),
    ...
    ScadaDisplayHelper::ScadaDisplayHelper(const ta_uint32 row, TA_Base_Core::IData& data)
        :
        m_key(0),
        m_name(""),
        m_path(""),
    ...
    ta_uint32 ScadaDisplayHelper::getKey()
    {
    ...
    {
        FUNCTION_ENTRY("ScadaDisplayHelper::setName");
    ...
    ta_uint32 ScadaDisplayHelper::getLocation()
    {
        if (!m_isValidData && !m_isNew)
        {
            reload();
    ...
    void ScadaDisplayHelper::setLocation(const ta_uint32 location)
    {
        if (!m_isValidData && !m_isNew)
        {
            reload();
    ...
    void ScadaDisplayHelper::reload()
    {
        ...
        IDatabase* databaseConnection = DatabaseFactory::getInstance().getDatabase(Scada_SCd/*Scada_Cd*/, Read);
    ...
    void ScadaDisplayHelper::reloadUsing(const ta_uint32 row, TA_Base_Core::IData& data)
    {
    ...
    void ScadaDisplayHelper::writeData()
    {
        ...
        // get a connection to the database
        IDatabase* databaseConnection = DatabaseFactory::getInstance().getDatabase(Scada_Cd, Write);
    ...
    void ScadaDisplayHelper::deleteDisplay()
    {
        ...
        // get a connection to the database
        IDatabase* databaseConnection = DatabaseFactory::getInstance().getDatabase(Scada_SCd/*Scada_Cd*/, Write);
    ...
    void ScadaDisplayHelper::checkForReferencesFromProfileParameterTable()
    {
        ...
        IDatabase* databaseConnection =
            DatabaseFactory::getInstance().getDatabase(Scada_Cd, Read);
    ...
    std::string ScadaDisplayHelper::getCommaSeparatedList(IData* data, const std::string&  columnName)
    {
    ...
    void ScadaDisplayHelper::modifyExisting()
    {
        ...
        LOG_DEBUG("Display %s already exists. It's data will be updated.", m_name);
    ...
    void ScadaDisplayHelper::addNew()
    {
        ...
        LOG_DEBUG("Display %s is a new display. It will be added to the database.", m_name);
