 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/ActionGroupHelper.h $
 * @author:  Karen Graham
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    public:
         ...
         */
        ActionGroupHelper(const ta_uint32 key, const std::string& name);
         ...
         */
        ActionGroupHelper(const ta_uint32 row, TA_Base_Core::IData& data, std::vector<ta_uint32>& actions);
         ...
         *             ta_uint32 ), or if the wrong ammount of data is retrieved.
         */
        bool isActionIncluded(ta_uint32 actionKey);
    ...
    private:
         ...
         *             - NOT_UNIQUE if the primary key returns multiple records
         */
        void reloadUsing(const ta_uint32 row, TA_Base_Core::IData& data, std::vector<ta_uint32>& actions);
