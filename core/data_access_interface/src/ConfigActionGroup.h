 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/ConfigActionGroup.h $
 * @author:  Karen Graham
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    public:
         ...
         */
        ConfigActionGroup(const ta_uint32 key, const std::string& name);
         ...
         */
        ConfigActionGroup(const ta_uint32 row, TA_Base_Core::IData& data, std::vector<ta_uint32>& actions);
         ...
         *
         * @return The key for this ActionGroup as an ta_uint32 .
         */
         ...
         *
         * @param ta_uint32 - The action key to check for
         *
         ...
         *             ta_uint32 ), or if the wrong ammount of data is retrieved.
         */
        virtual bool isActionIncluded(ta_uint32 actionKey);
         ...
         *
         * @param ta_uint32 - The key of the action.
         *
         * @exception DatabaseException A DatabaseException will be thrown if there is a
         *            problem establishing a connection with the database, or if an
         *            error is encountered while retrieving data.
         ...
         *             ta_uint32 ), or if the wrong ammount of data is retrieved.
         */
        virtual void addAction(ta_uint32 actionKey);
         ...
         *             ta_uint32 ), or if the wrong ammount of data is retrieved.
         */
        virtual void removeAction(ta_uint32 actionKey);
    ...
    private:
        ...
        ta_uint32 m_uniqueIdentifier; // We cannot use keys for identification of actions in the
