 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/OnlinePrintCfgAccessFactory.cpp $
 * @author:  Ripple
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    std::vector<OnlinePrintCfgAccessFactory::LocationRecord> OnlinePrintCfgAccessFactory::getUnusedLocations()
    {
        ...
        do
        {
            for (ta_uint32 i = 0; i < data->getNumRows(); ++i)
            {
                ta_uint32 id = data->getUnsignedLongData(i, "PKEY");
    ...
    IOnlinePrintCfg* OnlinePrintCfgAccessFactory::getOnlinePrintCfg(const ta_uint32 idKey, const bool readWrite)
    {
