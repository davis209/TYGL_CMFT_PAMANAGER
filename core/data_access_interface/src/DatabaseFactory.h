 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/DatabaseFactory.h $
 * @author:  Nick Jardine
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    public:
        ...
        DatabaseFactory(const DatabaseFactory& theDatabaseFactory) = delete;
         ...
         */
        IDatabase* getDatabase(EDataTypes, EDataActions, const std::string& options = "");
        IDatabase* getDatabase(EDataTypes, EDataActions, IDatabase*);
        IDatabase* getDatabase(const std::vector<EDataTypes>&, EDataActions);
