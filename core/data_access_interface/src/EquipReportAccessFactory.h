 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/EquipReportAccessFactory.h $
 * @author:  Ripple
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    public:
        ...
        bool equipReportAlreadyExistsAtLocationByName(const ta_uint32 aLocationKey, const std::string& aEquipReportName);
        ...
        std::vector<IEquipReport*> getAllEquipReportsByLocationKey(ta_uint32 aLocationKey, const bool readWrite = false);
