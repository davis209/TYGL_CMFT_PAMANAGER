 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/ConfigEquipReport.cpp $
 * @author:  Ripple
 * @version: $Revision: #3 $
 *
...
{
    ta_int32 ConfigEquipReport::s_nextAvailableIdentifier = 0;
    ...
    ConfigEquipReport::ConfigEquipReport(std::string& key,
                                         ...
                                         const ta_uint32 locationId)
        : m_EquipReportHelper(new EquipReportHelper(key, name, locationId)),
          m_uniqueIdentifier(s_nextAvailableIdentifier++)
    {
    }

    ConfigEquipReport::ConfigEquipReport(const ta_uint32 row, TA_Base_Core::IData& data)
    ...
    ta_uint32 ConfigEquipReport::getKey()
    {
        TA_ASSERT(m_EquipReportHelper != NULL, "The equipment report helper is NULL");
    ...
    ta_uint32 ConfigEquipReport::getLocationId()
    {
        TA_ASSERT(m_EquipReportHelper != NULL, "The equipment report helper is NULL");
    ...
    ta_uint32 ConfigEquipReport::getProfile()
    {
        TA_ASSERT(m_EquipReportHelper != NULL, "The equipment report helper is NULL");
    ...
    void ConfigEquipReport::setLocationId(const ta_uint32 locationId)
    {
        TA_ASSERT(m_EquipReportHelper != NULL, "The equipment report helper is NULL");
    ...
    void ConfigEquipReport::setProfile(const ta_uint32 profile)
    {
        TA_ASSERT(m_EquipReportHelper != NULL, "The equipment report helper is NULL");
