 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/SubsystemAccessFactory.cpp $
 * @author:  Karen Graham
 * @version: $Revision: #4 $
 *
...
namespace TA_Base_Core
{
    ...
    ISubsystem* SubsystemAccessFactory::getSubsystemByKey(const ta_uint32 key, const bool readWrite)
    {
    ...
    std::vector<ISubsystem*> SubsystemAccessFactory::getSubsystemBySystemKeys(std::vector<ta_uint32> keys, const bool readWrite)
    {
    ...
    std::vector<ISubsystem*> SubsystemAccessFactory::getSubsystemsByRegion(ta_uint32 regionKey, const bool readWrite)
    {
    ...
    IConfigSubsystem* SubsystemAccessFactory::copySubsystem(const IConfigSubsystem* subsystemToCopy)
    {
