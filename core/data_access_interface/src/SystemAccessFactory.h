 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/SystemAccessFactory.h $
 * @author:  Lu Xiangmei
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    private:
         ...
         */
        SystemData* createSystemData(ta_uint32 row, IData* data);
    };
};
