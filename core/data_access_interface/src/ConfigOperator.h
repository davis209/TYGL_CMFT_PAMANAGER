 ...
 * in any form.
 *
 * Source: $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/ConfigOperator.h $
 * @author Nick Jardine
 * @version $Revision: #3 $
...
namespace TA_Base_Core
{
    ...
    public:
         ...
         */
        ConfigOperator(const ta_uint32 key);
         ...
         */
        ConfigOperator(const ta_uint32 row, TA_Base_Core::IData& data, std::vector<ta_uint32>& profiles, std::vector<ta_uint32>& regions);
    ...
    public:
         ...
         *             ta_uint32 ), or if the wrong ammount of data is retrieved.
         */
        virtual std::string getPassword(const std::string& options);
         ...
         * pre: This operator has not been deleted
         */
        virtual void setSALT(const std::string strSALT);
         ...
         * pre: This operator has not been deleted
         */
        virtual void setAssociatedProfile(ta_uint32 profileKey, bool isAssociated);
    ...
    private:
         ...
         *               removed.
         */
        bool haveProfilesChanged(ta_uint32 profileKey, bool isAssociated);
        ...
        ta_uint32 m_uniqueIdentifier; // We cannot use keys for identification of operators in the
        ...
        std::set<ta_uint32> m_originalProfiles; // This is a set of all the original profiles
        // associated with this operator. This is used to determine
        // whether changes have been made and allows us to report
        // those changes.
        std::set<ta_uint32> m_newProfiles;      // This is a set of all the profile changes. This allows us
