 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/SubsystemStateAccessFactory.h $
 * @author:  Anita Lee
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    public:
         ...
         */
        ISubsystemState* getSubsystemState(const ta_uint32 subsystemStateKey);
