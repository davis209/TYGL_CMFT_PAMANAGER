 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/RegionAccessFactory.h $
 * @author:  Karen Graham
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    public:
         ...
         * @exception DataException
         */
        IRegion* getRegionByKey(const ta_uint32 regionKey, const bool readWrite = false);
         ...
         * @exception DataException
         */
        std::vector<IRegion*> getRegionsByOperator(const ta_uint32 operatorKey);
         ...
         * @exception DataException
         */
        std::vector<IRegion*> getRegionsByLocation(const ta_uint32 locationKey);
    ...
    private:
        ...
        void getRegionIDsBySql(IDatabase* pDatabase, const SQLStatement& sql, std::vector<ta_uint32>& regionIDs);
