 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/ConfigSubsystem.h $
...
namespace TA_Base_Core
{
    ...
    public:
         ...
         */
        ConfigSubsystem(const ta_uint32 key);
         ...
         */
        ConfigSubsystem(const ta_uint32 row, TA_Base_Core::IData& data);
         ...
         */
        virtual ta_uint32 getSystemKey();
         ...
         *
         * Sets whether the subsystem is a physical subsystem or not.
         *
         * @param isExclusive  true if the subsystem is a physical subsystem,
         *                     false otherwise.
         *
         * @exception DatabaseException A DatabaseException will be thrown if there is a
         *            problem establishing a connection with the database, or if an
         ...
         *            the subsystem key is invalid (and this is not a new subsystem).
		 */
		virtual void setPhysicalSubsystemStatus(bool isPhysical);
    ...
    private:
        ...
        ta_uint32 m_uniqueIdentifier; // We cannot use keys for identification of subsystems in the
