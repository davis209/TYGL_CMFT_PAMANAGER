 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/OnlinePrinterHelper.h $
 * @author:  Nick Jardine
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    public:
         ...
         *
         */
        OnlinePrinterHelper(const ta_uint32 idKey);
         ...
         *
         */
        OnlinePrinterHelper(ta_uint32 row, TA_Base_Core::IData& data);
        ...
        ta_uint32 getLocation();
        bool getIsAlarm();

        void setPrinter(const std::string& pPrinter);
        void setSubsystem(ta_uint32 pSubsystem);
        void setLocation(ta_uint32 pLocation);
    ...
    private:
         ...
         * @throws DataException
         *         - if the data cannot be converted to the required format
         *           (e.g. OnlinePrinterId should be an ta_uint32)
         ...
         *
         */
        void modifyExistingOnlinePrinter();
         ...
         *
         */
        void addNewOnlinePrinter();

        int m_idKey;
        std::string m_printer;
        ta_uint32 m_subsystem;
        ta_uint32 m_location;
        bool m_isAlarm;
