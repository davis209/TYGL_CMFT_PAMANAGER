 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/EventColourAccessFactory.h $
 * @author:  Derrick Liew
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    public:
         ...
         */
        IEventColourData* getEventColourByKey(const ta_uint32 key, const bool readWrite = false);
