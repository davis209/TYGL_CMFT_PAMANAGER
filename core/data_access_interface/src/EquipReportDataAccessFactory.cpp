 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/EquipReportDataAccessFactory.cpp $
 * @author:  Ripple
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    IEquipReportData* EquipReportDataAccessFactory::getEquipReportDataKey(std::string& aReportKey, ta_uint32 aEntityKey)
    {
        if (aEntityKey == 0)
        {
            return NULL;
