 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/EquipReportAccessFactory.cpp $
 * @author:  Ripple
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    std::vector<IEquipReport*>EquipReportAccessFactory::getAllEquipReportsByLocationKey(ta_uint32 aLocationKey, const bool readWrite)
    {
    ...
    bool EquipReportAccessFactory::equipReportAlreadyExistsAtLocationByName(const ta_uint32 aLocationKey, const std::string& aEquipReportName)
    {
