 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/EquipReportDataHelper.h $
 * @author:  Ripple
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    public:
        ...
        // set methods
        void setDataPointKey(const ta_uint32 aDataPointKey);
        void setDataNodeKey(const ta_uint32 aDataNodeKey);
         ...
         */
        EquipReportDataHelper(const ta_uint32 row, TA_Base_Core::IData& data);
    ...
    private:
        ...
        ta_uint32 m_DataNodeKey;
        ta_uint32 m_DataPointKey;
