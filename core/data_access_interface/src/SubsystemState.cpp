/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/SubsystemState.cpp $
  * @author:  Anita Lee
  * @version: $Revision: #3 $
  *
...
namespace TA_Base_Core
{
    ...
    SubsystemState::SubsystemState(const ta_uint32 key)
        : m_isValidData(false),
          m_key(key),
          m_name(""),
          m_description("")
    ...
    SubsystemState::SubsystemState(const ta_uint32 key, const std::string& name, const std::string& description)
        : m_isValidData(false),
          m_key(key),
          m_name(name),
    ...
    ta_uint32 SubsystemState::getKey()
    {
        return m_key;
    }
