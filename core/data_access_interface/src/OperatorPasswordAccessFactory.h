 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/OperatorPasswordAccessFactory.h $
 * @author:  Karen Graham
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    public:
         ...
         */
        IOperatorPassword* getOperatorPassword(ta_uint32 operatorkey, bool changePassword, bool rightPassword);

        IOperatorPassword* CreateOperatorPassword(ta_uint32 operatorkey);
