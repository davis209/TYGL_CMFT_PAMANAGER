...
namespace TA_Base_Core
{
    ...
    public:
         ...
         *
         * @return The port of naming service as an ta_uint32
         */
        virtual ta_uint32 getPrimaryPort();
         ...
         * @return The port of naming service as an ta_uint32
         */
        virtual ta_uint32 getSecondaryPort();
         ...
         *
         * @return The naming service port as ta_uint32
         */
        virtual ta_uint32 getNsPort(const std::string hostname);
    ...
    private:
        ...
        ta_uint32 m_primaryPort;
        ta_uint32 m_secondaryPort;
