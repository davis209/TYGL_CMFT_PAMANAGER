 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/ConfigLocation.h $
 * @author:  Karen Graham
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    public:
         ...
         */
        ConfigLocation(const ta_uint32 key);
         ...
         */
        ConfigLocation(const ta_uint32 key, const std::string& name, const std::string& description, const ta_uint32 orderId,
         ...
         */
        ConfigLocation(const ta_uint32 row, TA_Base_Core::IData& data);
         ...
         *
         * @return The key for this Location as an ta_uint32 .
         */
         ...
         *            the location key is invalid (and this is not a new location).
         */
        virtual void setOrderId(const ta_uint32 orderId);
         ...
         * setLocationType
         *
         * Sets the location type of this location locally.
         *
         * @param locationType The location type to give this location.
         *
         * @exception DatabaseException A DatabaseException will be thrown if there is a
         *            problem establishing a connection with the database, or if an
         *            error is encountered while retrieving data.
         ...
         *            the location key is invalid (and this is not a new location).
         */
        virtual void setLocationType(const std::string &locationType);
         ...
         * @param ta_uint32 profileKey - the profileKey for the display
         *
         ...
         *             ta_uint32 ), or if the wrong ammount of data is retrieved.
         */
        virtual std::string getDefaultDisplay(ta_uint32 profileKey, int displayNumber);
         ...
         *             ta_uint32 ), or if the wrong ammount of data is retrieved.
         */
        virtual bool isProfileAssociated(ta_uint32 profileId);
    ...
    private:
        ...
        static const std::string LOCATIONTYPE;

        LocationHelper* m_locationHelper;

        ta_uint32 m_uniqueIdentifier; // We cannot use keys for identification of locations in the
