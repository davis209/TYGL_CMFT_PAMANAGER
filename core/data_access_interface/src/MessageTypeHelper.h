 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/MessageTypeHelper.h $
 * @author:  Nick Jardine
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    public:
        ...
        MessageTypeHelper(const std::string& key): m_isValidData(false), m_key(key), m_name(""), m_displayname(""), m_description(""), m_priority(10),
            ...
            m_isRealTimeEvent(false), m_actionID(0), m_isSystemEvent(false) {};
        ...
        MessageTypeHelper(const std::string& key,
            ...
            : m_isValidData(true), m_key(key), m_name(name), m_displayname(""), m_description(description), m_priority(priority),
              ...
              m_dateModified(0), m_viewLevel(viewLevel), m_isRealTimeEvent(isRealTimeEvent), m_actionID(actionID), m_isSystemEvent(isSystemEvent) {};
         ...
         */
        MessageTypeHelper(const ta_uint32 row, TA_Base_Core::IData& data);
