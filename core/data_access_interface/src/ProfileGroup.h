 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/ProfileGroup.h $
 * @author:  Derrick Liew
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    public:
         ...
         */
        ProfileGroup(const ta_uint32 key);
         ...
         */
        ProfileGroup(const ta_uint32 key, const std::string& name);
         ...
         */
        ProfileGroup(const ta_uint32 row, TA_Base_Core::IData& data);
