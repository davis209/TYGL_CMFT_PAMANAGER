 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/ILocation.h $
 * @author:  Karen Graham
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    public:
         ...
         *             ta_uint32 ), or if the wrong ammount of data is retrieved.
         */
        virtual ta_uint32 getOrderId() = 0;
         ...
         *             ta_uint32 ), or if the wrong ammount of data is retrieved.
         */
        virtual std::string getDefaultDisplay(ta_uint32 profileKey, int displayNumber) = 0;
         ...
         *             ta_uint32 ), or if the wrong ammount of data is retrieved.
         */
        virtual bool isProfileAssociated(ta_uint32 profileId) = 0;
    ...
    typedef boost::shared_ptr<ILocationPtrList> ILocationPtrListPtr;
