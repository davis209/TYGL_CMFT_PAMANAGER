 ...
 * in any form.
 *
 * Source: $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/ConfigEventColourData.h $
 * @author Derrick Liew
 * @version $Revision: #3 $
...
namespace TA_Base_Core
{
    ...
    public:
        ...
        ConfigEventColourData(ta_uint32 pkey);
         ...
         */
        ConfigEventColourData(const ta_uint32 row, TA_Base_Core::IData& data);
         ...
         *             ta_uint32 ), or if the wrong amount of data is retrieved.
         */
        virtual void setEventColourKey(ta_uint32 colour, EEventColourType type = OPEN_ACKED_FG1);
         ...
         */
        virtual ta_uint32 getEventColourKey(EEventColourType type = OPEN_ACKED_FG1);
