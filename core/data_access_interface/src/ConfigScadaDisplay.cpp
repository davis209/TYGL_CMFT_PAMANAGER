 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/ConfigScadaDisplay.cpp $
 * @author:  Karen Graham
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    ta_int32 ConfigScadaDisplay::s_nextAvailableIdentifier = 0;
    ...
    ConfigScadaDisplay::ConfigScadaDisplay(const ta_uint32 key)
        : m_displayHelper(new ScadaDisplayHelper(key)),
          m_uniqueIdentifier(s_nextAvailableIdentifier++)
    {
    }

    ConfigScadaDisplay::ConfigScadaDisplay(const ta_uint32 row, TA_Base_Core::IData& data)
    ...
    void ConfigScadaDisplay::setLocation(const ta_uint32 location)
    {
    ...
    ta_uint32 ConfigScadaDisplay::getKey()
    {
    ...
    ta_uint32 ConfigScadaDisplay::getLocation()
    {
