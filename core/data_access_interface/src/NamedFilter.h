 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/NamedFilter.h $
...
namespace TA_Base_Core
{
    ...
    public:
        ...
        static const ta_uint32 LIST_TYPE_STRING;
        static const ta_uint32 LIST_TYPE_NUMERIC;
         ...
         * @param value The value to add to the list.
         */
        virtual void addNumericFilter(const std::string& listName, const ta_uint32 value);
    ...
    private:
         ...
         *
         * @return ta_uint32 The GUI application key.
         */
        ta_uint32 getApplicationKey();
         ...
         */
        void saveFilterItem(const std::string& listName, const ta_uint32 listType, const std::string& listItem);
