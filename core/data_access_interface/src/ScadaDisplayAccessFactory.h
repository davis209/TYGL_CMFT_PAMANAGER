 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/ScadaDisplayAccessFactory.h $
 * @author:  Karen Graham
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    public:
         ...
         */
        IScadaDisplay* getScadaDisplay(const ta_uint32 key);
         ...
         */
        std::vector<IScadaDisplay*> getScadaDisplaysForLocation(const ta_uint32 locationKey);
