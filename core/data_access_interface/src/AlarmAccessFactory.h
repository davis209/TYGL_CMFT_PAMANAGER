 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/AlarmAccessFactory.h $
 * @author:  Nick Jardine
 * @version: $Revision: #3 $
 *
...
#include "core/data_access_interface/src/AlarmTopLocData.h"
#include "core/data_access_interface/src/AlarmMadbData.h"
...
namespace TA_Base_Core
{
    ...
    public:
        ...
        std::vector<IAlarmData*> getActiveAlarms(ta_uint32 maxCount);
         ...
         */
        std::vector<IAlarmData*> getActiveAlarmsForLocation(ta_uint32 p_locationKey);
        std::vector<IAlarmData*> getActiveAlarmsForLocation(ta_uint32 p_locationKey, ta_uint32 maxCount);
         ...
         * @exception DataException raised if the supplied location key is invalid
         */
        unsigned int getDBActiveAlarmCountForLocation(ta_uint32 locationKey);

		AlarmTopLocDataList getTop10Alarms(const time_t dateFrom, const time_t dateTo, const TopAlarmFilter& filter);
		AlarMadbData getMadbDataById(std::string madbID);
    ...
    private:
		...
		std::string buildTop10Filter(const TopAlarmFilter& filter);
