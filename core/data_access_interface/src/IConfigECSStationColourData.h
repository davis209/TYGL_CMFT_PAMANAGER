 ...
 * in any form.
 *
 * Source: $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/IConfigECSStationColourData.h $
 * @author Andy Siow
 * @version $Revision: #3 $
...
namespace TA_Base_Core
{
    ...
    public:
         ...
         *             ta_uint32 ), or if the wrong amount of data is retrieved.
         */
        virtual void setStationColourKey(ta_uint32 colour, EColourType type = CURRENT_PROPOSED_CF) = 0;
