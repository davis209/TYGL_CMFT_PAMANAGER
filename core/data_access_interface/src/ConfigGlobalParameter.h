 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/ConfigGlobalParameter.h $
 * @author:  Karen Graham
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    public:
         ...
         */
        ConfigGlobalParameter(const ta_uint32 key);
         ...
         */
        ConfigGlobalParameter(const ta_uint32 row, TA_Base_Core::IData& data);
         ...
         *
         * @return The key for this GlobalParameter as an ta_uint32 .
         */
        ...
        virtual void setSubsystemKey(ta_uint32 subsystemKey);
    ...
    private:
        ...
        ta_uint32 m_uniqueIdentifier; // We cannot use keys for identification of GlobalParameters in the
