 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/ConfigEquipReport.h $
 * @author:  Rod Rolirad
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    public:
        ...
        ConfigEquipReport(std::string& key, const std::string& name, const ta_uint32 locationId);
         ...
         */
        ConfigEquipReport(const ta_uint32 row, TA_Base_Core::IData& data);
        ...
        virtual ta_uint32 getLocationId();
        virtual ta_uint32 getProfile();
        ...
        virtual void setLocationId(const ta_uint32 locationId);
        virtual void setProfile(const ta_uint32 profile);
