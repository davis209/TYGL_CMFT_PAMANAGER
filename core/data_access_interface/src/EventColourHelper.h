 ...
 * in any form.
 *
 * Source: $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/EventColourHelper.h $
 * @author Derrick Liew
 * @version $Revision: #3 $
...
namespace TA_Base_Core
{
    ...
    public:
        ...
        EventColourHelper(ta_uint32 pkey);
         ...
         */
        EventColourHelper(const ta_uint32 row, TA_Base_Core::IData& data);
         ...
         *             ta_uint32 ), or if the wrong amount of data is retrieved.
         */
        void setEventColourKey(ta_uint32 colour, IEventColourData::EEventColourType type);
         ...
         */
        virtual ta_uint32 getEventColourKey(IEventColourData::EEventColourType type);
    ...
    private:
        ...
        std::string m_name;
        ta_uint32 m_key;
        std::map<IEventColourData::EEventColourType, ta_uint32> m_eventColourKey;
