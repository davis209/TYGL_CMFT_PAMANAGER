 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/IConfigEquipReport.h $
 * @author:  Ripple
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    public:
        ...
        virtual void setLocationId(const ta_uint32 locationId) = 0;
        virtual void setProfile(const ta_uint32 profile) = 0;
