 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/MessageAccessFactory.h $
 * @author:  Nick Jardine
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    public:
        ...
        struct MessageFilter
        {
            ...
            std::vector<ta_uint32> eventTypes;
            std::string assetName;       // If "", filter on entity name instead.
            std::vector<ta_uint32> operatorIds;
            std::vector<ta_uint32> severityIds;
            std::vector<ta_uint32> subsystemIds;
            std::vector<ta_uint32> locationIds;
            std::vector<ta_uint32> alarmTypes;
            std::string alarmId;
        };
        ...
        static const ta_uint32 INVALID_SEQUENCE_NUMBER;
        static const ta_uint32 MIN_SEQUENCE_NUMBER;
        static const ta_uint32 MAX_SEQUENCE_NUMBER;
        static const ta_uint32 MAX_ROWS;
         ...
         * @param callbackUser The callback object to allow GUI updates during a ta_int32 load process.
         *
         * @return A vector of pointers to objects conforming to the IMessageData interface.
         *
         * @exception DatabaseException A DatabaseException will be thrown if there are
        ...
        //             const ta_uint32 maxEvents = 0, MessageFilter* filter = NULL, IDatabaseCallbackUser* callbackUser = NULL, bool eventOnly = false);
         ...
         *            3) Error while attempting to execute a database query
         */
        //          ta_uint32 getNextMessageSequenceNumber();
         ...
         *            matching the supplied key.
         */
        //         std::vector<IMessageData*> getMessageOfEntityType(const ta_uint32 entityType,
        ...
        //TD 15056
        //zhou yuan++
        //      std::vector<IMessageData*> getMessageOfEntity(const ta_uint32 entityKey,
