 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/ProfileAccessFactory.h $
 * @author:  Karen Graham
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    public:
         ...
         */
        IProfile* getProfile(const ta_uint32 key, const bool readWrite = false);
    ...
    private:
         ...
         * getProfileIDsBySql
         *
         * Retrieves profile IDs by specified sql statement and returns the associated data as an
         * object conforming to the IProfile interface.
         *
         */
        void getProfileIDsBySql(IDatabase* pDatabase, const SQLStatement& sql, std::vector<ta_uint32>& profileIDs);
