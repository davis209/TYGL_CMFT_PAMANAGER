 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/IConfigActionGroup.h $
 * @author:  Karen Graham
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    public:
         ...
         *             ta_uint32 ), or if the wrong ammount of data is retrieved.
         */
        virtual void addAction(ta_uint32 actionKey) = 0;
         ...
         *             ta_uint32 ), or if the wrong ammount of data is retrieved.
         */
        virtual void removeAction(ta_uint32 actionKey) = 0;
         ...
         *             ta_uint32 ), or if the wrong ammount of data is retrieved.
         */
        virtual bool isActionIncluded(ta_uint32 actionKey) = 0;
