 ...
 * in any form.
 *
 * Source: $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/IOperator.h $
 * @author Nick Jardine
 * @version $Revision: #3 $
...
namespace TA_Base_Core
{
    ...
    public:
         ...
         *             ta_uint32 ), or if the wrong ammount of data is retrieved.
         */
        virtual std::string getPassword(const std::string& options = "") = 0;
         ...
         *             ta_uint32 ), or if the wrong ammount of data is retrieved.
         */
        virtual std::vector<ta_uint32> getAssociatedRegionKeys() = 0;

        virtual ~IOperator() {};
    };

    using IOperatorPtr = boost::shared_ptr<IOperator>;
    using IOperatorPtrList = std::vector<IOperatorPtr>;
    using IOperatorPtrListPtr = boost::shared_ptr<IOperatorPtrList>;
}
