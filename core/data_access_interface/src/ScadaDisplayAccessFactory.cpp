 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/ScadaDisplayAccessFactory.cpp $
 * @author:  Karen Graham
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    IScadaDisplay* ScadaDisplayAccessFactory::getScadaDisplay(const ta_uint32 key)
    {
    ...
    std::vector<IScadaDisplay*> ScadaDisplayAccessFactory::getScadaDisplaysForLocation(const ta_uint32 locationKey)
    {
    ...
    std::vector<IScadaDisplay*> ScadaDisplayAccessFactory::getAllScadaDisplays(const bool readWrite)
    {
        ...
        auto strSql = databaseConnection->preparedSQLStatement(SC_SCADA_SCHEMATIC_SELECT_20054);
