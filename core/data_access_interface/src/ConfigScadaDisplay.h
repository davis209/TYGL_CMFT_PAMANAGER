 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/ConfigScadaDisplay.h $
 * @author:  Karen Graham
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    public:
         ...
         */
        ConfigScadaDisplay(const ta_uint32 key);
         ...
         */
        ConfigScadaDisplay(const ta_uint32 row, TA_Base_Core::IData& data);
    ...
    public:
         ...
         *
         * @param ta_uint32 - The key of the location for this display
         *
         * pre: This display has not been deleted
         */
        void setLocation(ta_uint32 location);
         ...
         *
         * @return ta_uint32 - The unique identifier for this display
         */
    ...
    private:
        ...
        ta_uint32 m_uniqueIdentifier; // We cannot use keys for identification of displays in the
