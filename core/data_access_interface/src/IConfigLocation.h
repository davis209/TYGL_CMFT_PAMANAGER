 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/IConfigLocation.h $
 * @author:  Karen Graham
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    public:
         ...
         *            the location key is invalid (and this is not a new location).
         */
        virtual void setOrderId(const ta_uint32 orderId) = 0;
         ...
         *            the location key is invalid (and this is not a new location).
         */
        virtual void setLocationType(const std::string &locationType) = 0;
