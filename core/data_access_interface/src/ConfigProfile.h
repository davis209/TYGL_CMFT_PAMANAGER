 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/ConfigProfile.h $
 * @author:  Karen Graham
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    public:
         ...
         */
        ConfigProfile(const ta_uint32 key);
         ...
         */
        ConfigProfile(const ta_uint32 row, TA_Base_Core::IData& data);
    ...
    public:
         ...
         *             ta_uint32 ), or if the wrong ammount of data is retrieved.
         */
        virtual std::string getDefaultDisplay(ta_uint32 locationKey, int displayNumber);
         ...
         *             ta_uint32 ), or if the wrong ammount of data is retrieved.
         */
        virtual std::string getParameterValue(ta_uint32 locationKey, const std::string& parameterName);
         ...
         *             ta_uint32 ), or if the wrong ammount of data is retrieved.
         */
        virtual std::string getParameterActualValue(ta_uint32 locationKey, const std::string& parameterName);
         ...
         *
         * @param ta_uint32 resourceKey - the pkey of the resource in question.
         *
         ...
         *             ta_uint32 ), or if the wrong ammount of data is retrieved.
         */
        virtual std::string getActionGroupAsStringForResource(ta_uint32 resourceKey);

        /**
         * See IProfile.h for a description of this method.
         */
        virtual std::string getActionGroupAsStringForSubsystem(ta_uint32 subsystemKey,
         ...
         *             ta_uint32 ), or if the wrong ammount of data is retrieved.
         */
        virtual bool getActionGroup(ta_uint32 subsystem, ta_uint32 subsystemState,
         ...
         *
         */
        virtual ta_uint32 getAccessControlGroup();
         ...
         * See IProfile.h for a description of this method.
         */
        virtual std::vector<ta_uint32> getAccessibleSubsystemKeys();
         ...
         */
        virtual ta_uint32 getDisplayKey(ta_uint32 locationKey, int displayNumber);
         ...
         */
        virtual void setType(const ta_uint32);
         ...
         *                       a negative value then that means that no display should be set.
         */
        virtual void setParameterValue(ta_uint32 location, const std::string& parameterName, const std::string& parameterValue);
         ...
         *
         * @return ta_uint32 - The unique identifier for this profile
         */
         ...
         * pre: This profile has not been deleted
         */
        virtual void setAccessControlGroup(ta_uint32 accessControlGroupKey);
         ...
         */
        virtual void setLocationAssociationStatus(const ta_uint32 locationId, const bool isAssociated);
    ...
    private:
        ...
        ta_uint32 m_uniqueIdentifier; // We cannot use keys for identification of profiles in the
