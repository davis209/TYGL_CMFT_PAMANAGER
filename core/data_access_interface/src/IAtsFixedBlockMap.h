 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/IAtsFixedBlockMap.h $
 * @author:  San Teo
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    public:
         ...
         */
        virtual double getZoneId(ta_uint32 branchId, ta_uint32 fixBlockAbscissa, ta_uint32 headCarAbscissa) = 0;
         ...
         */
        virtual std::string getTrack(ta_uint32 branchId, ta_uint32 fixBlockAbscissa, ta_uint32 headCarAbscissa) = 0;
    };
