 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/EventColourAccessFactory.cpp $
 * @author:  Derrick Liew
 * @version: $Revision: #4 $
 *
...
namespace TA_Base_Core
{
    ...
    IEventColourData* EventColourAccessFactory::getEventColourByKey(const ta_uint32 key, const bool readWrite)
    {
