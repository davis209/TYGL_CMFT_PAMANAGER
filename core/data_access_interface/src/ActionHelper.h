 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/ActionHelper.h $
...
namespace TA_Base_Core
{
    ...
    public:
         ...
         */
        ActionHelper(const ta_uint32 key, const std::string& name, const std::string& description);
         ...
         */
        ActionHelper(const ta_uint32 key, const std::string& name, const std::string& description, const bool isDisplayOnly);
        /**
         * ActionHelper
         *
         ...
         */
        ActionHelper(const ta_uint32 row, TA_Base_Core::IData& data, std::vector<std::string>& actionGroups);
    ...
    private:
         ...
         *             - NOT_UNIQUE if the primary key returns multiple records
         */
        void reloadUsing(const ta_uint32 row, TA_Base_Core::IData& data, std::vector<std::string>& actionGroups);
    };
