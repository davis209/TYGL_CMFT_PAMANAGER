 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/ConfigGui.h $
 * @author:  Karen Graham
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    public:
         ...
         */
        ConfigGui(const ta_uint32 row, TA_Base_Core::IData& data);
    ...
    private:
        ...
        static const std::string MAX_INSTANCES;
        ...
        // this constant
        static const ta_uint32 MAXIMUM_RESERVED_KEY;
