 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/AlarmSeverityData.h $
 * @author:  Andy Siow
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    public:
         ...
         */
        AlarmSeverityData(const ta_uint32 key);

        AlarmSeverityData(const ta_uint32 row, TA_Base_Core::IData& data);
         ...
         *
         * @return The key for this Alarm Severity as an ta_uint32 .
         */
        ta_uint32 getKey();
