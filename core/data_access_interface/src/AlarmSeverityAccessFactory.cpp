 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/AlarmSeverityAccessFactory.cpp $
 * @author:  Andy Siow
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    IAlarmSeverityData* AlarmSeverityAccessFactory::getSeverityByKey(const ta_uint32 key, const bool readWrite)
    {
