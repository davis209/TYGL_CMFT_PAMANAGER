 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/AlarmSeverityAccessFactory.h $
 * @author:  Andy Siow
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    public:
         ...
         */
        IAlarmSeverityData* getSeverityByKey(const ta_uint32 key, const bool readWrite = false);
