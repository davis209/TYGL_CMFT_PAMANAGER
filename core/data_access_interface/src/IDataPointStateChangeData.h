 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/IDataPointStateChangeData.h $
 * @author:  Nick Jardine
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    public:
        ...
        // Raymond Pau++
        // Bug#802 TD7194
        virtual void setMessage(ta_int32 generalMessage) = 0;
         ...
         */
        virtual void setEventTypeKey(const ta_uint32 eventTypeKey) = 0;
        // Bug#802 TD7194
        // ++Raymond Pau
