 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/DataPointStateChangeData.h $
 * @author:  Nick Jardine
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    public:
         ...
         */
        DataPointStateChangeData(const std::string& key, const std::map<std::string, ta_uint32>& alarmMessageDataPointNameToPKeyMap);
         ...
         */
        DataPointStateChangeData(const std::map<std::string, ta_uint32>& alarmMessageDataPointNameToPKeyMap);
         ...
         */
        DataPointStateChangeData(const std::string& key, const time_t timeStamp, const time_t logTime, const ta_uint32 entityKey,
        ...
        // Raymond Pau++
        // Bug#802 TD7194
        virtual void setMessage(ta_int32 generalMessage);
         ...
         */
        virtual void setEventTypeKey(const ta_uint32 eventTypeKey);
        // Bug#802 TD7194
        // ++Raymond Pau
    ...
    private:
        ...
        // Raymond Pau++
        // Bug #802 (TD7194)
        ta_uint32 m_alarmMessageId;
        ta_int32 m_generalMessageId;

        // The eventType key of this state change
        ta_uint32 m_eventTypeKey;

        const std::map<std::string, ta_uint32>& m_alarmMessageDataPointNameToPKeyMap;
        // Bug #802 (TD7194)
        // ++Raymond Pau
    };
}
