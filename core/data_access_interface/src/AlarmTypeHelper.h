 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/AlarmTypeHelper.h $
 * @author:  Nick Jardine
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    public:
         ...
         */
        AlarmTypeHelper(const ta_uint32 row, TA_Base_Core::IData& data);
         ...
         *
         * @return The severity level of the Alarm type as an ta_uint32 .
         *
         * @exception DatabaseException A DatabaseException will be thrown if there is a
         *            problem establishing a connection with the database, or if an
         *            error is encountered while retrieving data.
         ...
         * getContextKey
         *
         * @return The context key of the Alarm type as an ta_uint32 .
         *
    ...
    private:
        ...
        static const ta_uint32 AlarmTypeHelper::NEW_ALARM_TYPES_STARTING_PKEY;
    };
} // closes TA_Base_Core
