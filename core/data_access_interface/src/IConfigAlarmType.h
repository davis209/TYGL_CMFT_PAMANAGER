 ...
 * in any form.
 *
 * Source: $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/IConfigAlarmType.h $
 * @author Nick Jardine
 * @version $Revision: #3 $
...
namespace TA_Base_Core
{
    ...
    public:
         ...
         *            either 0 or 1), or if the wrong amount of data is retrieved.
         */
        virtual void setSeverityKey(const ta_uint32 severityKey) = 0;
