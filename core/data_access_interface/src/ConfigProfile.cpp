 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/ConfigProfile.cpp $
 * @author:  Karen Graham
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    ta_int32 ConfigProfile::s_nextAvailableIdentifier = 0;
    ...
    ConfigProfile::ConfigProfile(const ta_uint32 key)
        : m_profileHelper(new ProfileHelper(key)),
          m_uniqueIdentifier(s_nextAvailableIdentifier++)
    {
    }

    ConfigProfile::ConfigProfile(const ta_uint32 row, TA_Base_Core::IData& data)
    ...
    std::string ConfigProfile::getNiceLocationLabel(std::string oldLabel)
    {
        ...
        {
            LOG_EXCEPTION("DataException", "Could not retrieve the location name. The user will see an icky location key in the audit message.");
        }
        catch (const DatabaseException&)
        {
            LOG_EXCEPTION("DatabaseException", "Could not retrieve the location name. The user will see an icky location key in the audit message.");
        }
    ...
    std::string ConfigProfile::getNiceDisplayLabel(std::string oldLabel)
    {
        ...
        {
            LOG_EXCEPTION("DataException", "Could not retrieve the display name. The user will see an icky display key in the audit message.");
        }
        catch (const DatabaseException&)
        {
            LOG_EXCEPTION("DatabaseException", "Could not retrieve the display name. The user will see an icky display key in the audit message.");
        }
    ...
    void ConfigProfile::setType(const ta_uint32 type)
    {
    ...
    void ConfigProfile::removeDisplay(ta_uint32 location, ta_uint32 screenNumber)
    {
    ...
    void ConfigProfile::removeParameter(ta_uint32 location, const std::string& parameterName)
    {
        FUNCTION_ENTRY("removeDisplay");
    ...
    void ConfigProfile::setDisplay(ta_uint32 location, ta_uint32 screenNumber, ta_int32 display)
    {
    ...
    void ConfigProfile::setParameterValue(ta_uint32 location, const std::string& parameterName, const std::string& parameterValue)
    {
        FUNCTION_ENTRY("setDisplay");
    ...
    ta_uint32 ConfigProfile::getKey()
    {
    ...
    ta_uint32 ConfigProfile::getType()
    {
    ...
    ta_uint32 ConfigProfile::getAccessControlGroup()
    {
    ...
    std::vector<ta_uint32> ConfigProfile::getAccessibleSubsystemKeys()
    {
        TA_ASSERT(m_profileHelper != NULL, "The ProfileHelper was NULL");
    ...
    bool ConfigProfile::isLocationAssociated(ta_uint32 locationId)
    {
    ...
    std::string ConfigProfile::getDefaultDisplay(ta_uint32 locationKey, int displayNumber)
    {
        TA_ASSERT(m_profileHelper != NULL, "The ProfileHelper was NULL");
    ...
    std::string ConfigProfile::getParameterValue(ta_uint32 locationKey, const std::string& parameterName)
    {
        TA_ASSERT(m_profileHelper != NULL, "The ProfileHelper was NULL");
    ...
    std::string ConfigProfile::getParameterActualValue(ta_uint32 locationKey, const std::string& parameterName)
    {
        TA_ASSERT(m_profileHelper != NULL, "The ProfileHelper was NULL");
    ...
    ta_uint32 ConfigProfile::getDisplayKey(ta_uint32 locationKey, int displayNumber)
    {
        TA_ASSERT(m_profileHelper != NULL, "The ProfileHelper was NULL");
    ...
    std::vector<ta_uint32> ConfigProfile::getAssociatedLocationKeys()
    {
        TA_ASSERT(m_profileHelper != NULL, "The ProfileHelper was NULL");
    ...
    std::string ConfigProfile::getActionGroupAsStringForResource(ta_uint32 resourceKey)
    {
        TA_ASSERT(m_profileHelper != NULL, "The ProfileHelper was NULL");
    ...
    std::string ConfigProfile::getActionGroupAsStringForSubsystem(ta_uint32 subsystemKey,
    ...
    bool ConfigProfile::getActionGroup(ta_uint32 subsystem, ta_uint32 subsystemStateKey,
    ...
    void ConfigProfile::setAccessControlGroup(ta_uint32 accessControlGroupKey)
    {
    ...
    void ConfigProfile::setLocationAssociationStatus(const ta_uint32 locationId, const bool isAssociated)
    {
        ...
        std::vector<ta_uint32> associatedLocations = m_profileHelper->getAssociatedLocationKeys();
        ...
        std::vector<ta_uint32>::iterator searchResult = std::find(associatedLocations.begin(),
