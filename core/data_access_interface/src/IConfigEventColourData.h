 ...
 * in any form.
 *
 * Source: $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/IConfigEventColourData.h $
 * @author Derrick Liew
 * @version $Revision: #3 $
...
namespace TA_Base_Core
{
    ...
    public:
         ...
         *             ta_uint32 ), or if the wrong amount of data is retrieved.
         */
        virtual void setEventColourKey(ta_uint32 colour, EEventColourType type = OPEN_ACKED_FG1) = 0;
