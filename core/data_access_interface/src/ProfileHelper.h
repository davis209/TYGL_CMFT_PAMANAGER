 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/ProfileHelper.h $
...
namespace TA_Base_Core
{
    ...
    public:
        ...
        static const ta_uint32 CENTRAL_PROFILE_TYPE;
        static const ta_uint32 LOCAL_PROFILE_TYPE;
        /**
         * Constructor
         *
         ...
         */
        ProfileHelper(const ta_uint32 key);
         ...
         */
        ProfileHelper(const ta_uint32 row, TA_Base_Core::IData& data);
         ...
         * getType
         *
         * This method retrieves an ta_uint32 indicating the profile type
         *
         * @return An ta_uint32 key
         *
         * @exception DatabaseException A DatabaseException will be thrown if there is a
         *            problem establishing a connection with the database, or if an
         *            error is encountered while retrieving data.
         ...
         *
         * @param ta_uint32 - The key of the profile type.
         *
         ...
         *             ta_uint32 ), or if the wrong ammount of data is retrieved.
         */
        std::string getTypeName(ta_uint32 typeKey);
         ...
         *             ta_uint32 ), or if the wrong ammount of data is retrieved.
         */
        std::string getDefaultDisplay(ta_uint32 locationKey, int displayNumber);
         ...
         *             ta_uint32 ), or if the wrong ammount of data is retrieved.
         */
        std::string getParameterValue(ta_uint32 locationKey, const std::string& parameterName);
         ...
         * @param ta_uint32 locationKey - the locationKey for the profile is not required)
         *
         ...
         *             ta_uint32 ), or if the wrong ammount of data is retrieved.
         */
        std::string getParameterActualValue(ta_uint32 locationKey, const std::string& parameterName);
         ...
         */
        ta_uint32 getDisplayKey(ta_uint32 locationKey, int displayNumber);
         ...
         *            the specified display and location
         */
        ta_uint32 getDisplayKey(ta_uint32 locationKey, const std::string& parameterName);
         ...
         *             ta_uint32 ), or if the wrong ammount of data is retrieved.
         */
        virtual void setDisplay(ta_uint32 location, ta_uint32 screenNumber, ta_int32 display);
         ...
         *
         * @param ta_uint32 location - This is the location key that this display is for
         * @param ta_uint32 parameterName - This is the display name that distinguishes between the displays.
         * @param ta_int32 display - This is the key of the display from the SC_SCADA_SCHEMATIC table. If this is
         *                       a negative value then that means that no display should be set.
         *
         * @exception DatabaseException A DatabaseException will be thrown if there is a
         ...
         *             ta_uint32 ), or if the wrong ammount of data is retrieved.
         */
        virtual void setParameter(ta_uint32 location, const std::string& parameterName, const std::string& parameterValue);
         ...
         *             ta_uint32 ), or if the wrong ammount of data is retrieved.
         */
        virtual void removeDisplay(ta_uint32 location, ta_uint32 screenNumber);
         ...
         *
         * @param ta_uint32 location - This is the location key that the display is to be removed for
         * @param ta_uint32 parameterName - This is the display is to be removed.
         *
         * @exception DatabaseException A DatabaseException will be thrown if there is a
         *            problem establishing a connection with the database, or if an
         *            error is encountered while retrieving data.
         ...
         *             ta_uint32 ), or if the wrong ammount of data is retrieved.
         */
        virtual void removeParameter(ta_uint32 location, const std::string& parameterName);
         ...
         *             ta_uint32 ), or if the wrong ammount of data is retrieved.
         */
        virtual std::vector<ta_uint32> getAssociatedLocationKeys();

        /**
         * See IProfile.h for a description of this method.
         */
        std::string getActionGroupAsStringForResource(ta_uint32 resourceKey);

        /**
         * See IProfile.h for a description of this method.
         */
        std::string getActionGroupAsStringForSubsystem(ta_uint32 subsystemKey,
                                                       ta_uint32 subsystemStateKey);

        /**
         * See IProfile.h for a description of this method.
         */
        bool getActionGroup(ta_uint32 subsystem, ta_uint32 subsystemState,
         ...
         *
         */
        ta_uint32 getAccessControlGroup();
         ...
         * See IProfile.h for a description of this method.
         */
        std::vector<ta_uint32> getAccessibleSubsystemKeys();
         ...
         *
         * @param ta_uint32 - The key of the access control group.
         *
         ...
         *             ta_uint32 ), or if the wrong ammount of data is retrieved.
         */
        std::string getAccessControlGroupName(ta_uint32 accessControlGroupKey);
         ...
         * pre: This profile has not been deleted
         */
        void setAccessControlGroup(ta_uint32 accessControlGroupKey);
         ...
         *
         * @param ta_uint32 - The pa priority group key
         *
         * pre: This profile has not been deleted
         */
         ...
         */
        void addLocationAssocation(ta_uint32 locationId);
         ...
         */
        void removeLocationAssociaiton(ta_uint32 locationId);
         ...
         *             ta_uint32 ), or if the wrong ammount of data is retrieved.
         */
        virtual bool isLocationAssociated(ta_uint32 locationId);
    ...
    private:
        ...
        static const ta_uint32 NORMAL_SUBSYSTEM_STATE;
         ...
         * @param ta_uint32 - This is the maximum size of the field that the database will allow.
         *
         ...
         *            the entity key is invalid (and this is not a new entity).
         */
        std::string retrieveDeletedField(const std::string& currentField, const std::string& columnName, ta_uint32 maxFieldSize);
        ...
        ta_uint32 getSubsystemForResource(ta_uint32 resourceKey);
         ...
         */
        std::vector<ta_uint32> getLocationKeys();

        static const std::string DELETED_FLAG;

        static const ta_uint32 DEFAULT_NAME_MAX_LENGTH;

        static const ta_uint32 INVALID_ACCESS_CONTROL_GROUP_KEY;
        ...
        ta_uint32 m_type;
        ta_uint32 m_accessControlGroup;
        ...
        static volatile ta_uint32 m_nameMaxLength;
        ...
        public:
            ...
            ActionGroupEntry();
            ActionGroupEntry(ta_uint32 actionGroupKey, bool isControl);
            ActionGroupEntry(const ActionGroupEntry& rhs);
            ActionGroupEntry& operator=(const ActionGroupEntry& rhs);

            ta_uint32 m_actionGroupKey;
            bool          m_isControl;
        };

        typedef std::vector<ta_uint32> ActionGroupKey;
        ...
        typedef std::map<ta_uint32, ProfileParameters> DefaultProfileParamMap;
        ...
        typedef std::map<ta_uint32, ta_uint32> SubsystemMap;
        SubsystemMap m_subsystemMap;

        std::map<ta_uint32, std::string> m_profileTypes;

        std::vector<ta_uint32> m_accessibleSubsystems;
        std::vector<ta_uint32> m_associatedLocationKeys;
    };
