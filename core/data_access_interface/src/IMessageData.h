 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/IMessageData.h $
 * @author:  Nick Jardine
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    public:
        ...
        virtual void setLocationKey(ta_uint32 locationKey) = 0;
        ...
        virtual void setEventLelOrSeverityKey(const ta_uint32 eventLelOrSeverityKey) = 0;
        virtual void setAlarmTypeKey(const ta_uint32 alarmTypeKey) = 0;
