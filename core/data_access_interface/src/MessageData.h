 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/MessageData.h $
 * @author:  Nick Jardine
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    public:
        ...
        MessageData()
            : m_isValidData(false), m_key(""), m_description(""),
              ...
              m_entityKey(TA_MAX_UINT32), m_sessionID(" "), m_isNew(true),
              // TD13673
         ...
         *
         * @return The key for this message as an ta_uint32 .
         */
        ...
        virtual void setType(const ta_uint32 typeKey);
        ...
        virtual void setEntityKey(const ta_uint32 key);
        ...
        virtual void setEventLelOrSeverityKey(const ta_uint32 eventLelOrSeverityKey);
        virtual void setAlarmTypeKey(const ta_uint32 alarmTypeKey);
    ...
    private:
        ...
        std::string m_OMFlag;
        ta_uint32 m_eventLelOrSeverityKey;
