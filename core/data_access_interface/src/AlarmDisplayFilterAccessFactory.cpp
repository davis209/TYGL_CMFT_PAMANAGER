 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/AlarmDisplayFilterAccessFactory.cpp $
...
namespace TA_Base_Core
{
     ...
     * getFilterData
     */
    IAlarmDisplayFilterData* AlarmDisplayFilterAccessFactory::getFilterData(const ta_uint32& _pkey)
    {
     ...
     */
    std::vector<IAlarmDisplayFilterData*> AlarmDisplayFilterAccessFactory::getLocationsFilterData(const ta_uint32& _locationKey)
    {
        ...
        do
        {
            // Assign the data as appropriate to the member variables.
            // These calls can throw DataExceptions, as documented in the comment of this method.
            for (ta_uint32 idx = 0; idx < data->getNumRows(); idx++)
            {
