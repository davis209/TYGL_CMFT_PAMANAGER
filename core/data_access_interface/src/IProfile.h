 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/IProfile.h $
 * @author:  Karen Graham
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    public:
         ...
         */
        virtual std::string getDefaultDisplay(ta_uint32 locationKey, int displayNumber) = 0;
         ...
         *             ta_uint32 ), or if the wrong ammount of data is retrieved.
         */
        virtual std::string getParameterValue(ta_uint32 locationKey, const std::string& parameterName) = 0;
         ...
         *             ta_uint32 ), or if the wrong ammount of data is retrieved.
         */
        virtual std::vector<ta_uint32> getAssociatedLocationKeys() = 0;
         ...
         *             ta_uint32 ), or if the wrong ammount of data is retrieved.
         */
        virtual std::string getActionGroupAsStringForResource(ta_uint32 resourceKey) = 0;
         ...
         *
         * @param ta_uint32 subsystemKey - the pkey of the subsystem in question.
         *
         * @return A std::string containing the ActionGroup name. A std::string of size
        ...
        virtual bool getActionGroup(ta_uint32 subsystem, ta_uint32 subsystemState,
                                    ta_uint32& actionGroup, bool& isControl) = 0;
         ...
         *
         * @return unisgned ta_int32 Indicates the Access Control group to which this profile belongs
         * unless the group is null, it then indicates the profile pkey.
         */
        virtual ta_uint32 getAccessControlGroup() = 0;
         ...
         *             ta_uint32 ), or if the wrong ammount of data is retrieved.
         */
        virtual std::vector<ta_uint32> getAccessibleSubsystemKeys() = 0;
         ...
         *             ta_uint32 ), or if the wrong ammount of data is retrieved.
         */
        virtual bool isLocationAssociated(ta_uint32 locationId) = 0;
    ...
    typedef boost::shared_ptr<IProfilePtrList> IProfilePtrListPtr;
