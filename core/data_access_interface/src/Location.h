 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/Location.h $
 * @author:  Karen Graham
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    public:
         ...
         */
        Location(const ta_uint32 key, const std::string& name, const std::string& description, const ta_uint32 orderId, const std::string& displayname,
         ...
         */
        Location(const ta_uint32 row, TA_Base_Core::IData& data);
