 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/IConfigRights.h $
 * @author:  Karen Graham
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    public:
         ...
         */
        virtual ta_uint32 getUniqueIdentifier() = 0;
         ...
         *
         */
        virtual void setActionGroupKey(ta_int32 actionGroupKey) = 0;
         ...
         */
        virtual void setSubsystemState(ta_uint32 subsystemStateKey) = 0;
