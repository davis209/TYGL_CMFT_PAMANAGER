 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/Profile.h $
 * @author:  Karen Graham
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    public:
         ...
         */
        Profile(const ta_uint32 row, TA_Base_Core::IData& data);
         ...
         *             ta_uint32 ), or if the wrong ammount of data is retrieved.
         */
        bool isLocationAssociated(ta_uint32 locationId);
