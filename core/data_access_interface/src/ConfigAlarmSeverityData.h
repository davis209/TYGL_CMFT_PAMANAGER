 ...
 * in any form.
 *
 * Source: $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/ConfigAlarmSeverityData.h $
...
namespace TA_Base_Core
{
    ...
    public:
         ...
         *             ta_uint32 ), or if the wrong amount of data is retrieved.
         */
        virtual void setSeverityColourKey(ta_uint32 colour, EColourType type = OPEN_ACKED_FG1);
         ...
         */
        virtual ta_uint32 getSeverityColourKey(EColourType type = OPEN_ACKED_FG1);
        ...
        ConfigAlarmSeverityData(ta_uint32 pkey);

        ConfigAlarmSeverityData(const ta_uint32 row, TA_Base_Core::IData& data);
