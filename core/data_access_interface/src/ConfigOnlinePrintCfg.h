 ...
 * in any form.
 *
 * Source: $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/ConfigOnlinePrintCfg.h $
 * @author Nick Jardine
 * @version $Revision: #3 $
...
namespace TA_Base_Core
{
    ...
    public:
         ...
         */
        ConfigOnlinePrintCfg(const ta_uint32 idKey);
         ...
         *
         */
        ConfigOnlinePrintCfg(ta_uint32 row, TA_Base_Core::IData& data);
