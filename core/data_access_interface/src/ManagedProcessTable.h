 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/ManagedProcessTable.h $
...
{
    struct ManagedProcessTable
    {
        struct Row
        {
            size_t snscon_id;
            size_t managed_process_pkey;
            size_t default_operating_mode;
        };
