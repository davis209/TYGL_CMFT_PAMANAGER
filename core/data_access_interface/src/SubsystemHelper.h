 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/SubsystemHelper.h $
...
namespace TA_Base_Core
{
    ...
    public:
         ...
         */
        SubsystemHelper(const ta_uint32 key);
         ...
         */
        SubsystemHelper(const ta_uint32 row, TA_Base_Core::IData& data);
         ...
         *
         * @return The key for this Subsystem as an ta_uint32 .
         */
