 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/DataPointStateChangeAccessFactory.cpp $
 * @author:  Nick Jardine
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
        ...
        : m_stopLoad(false), m_pauseLoad(false)
    {
        ...
        try
        {
            ...
            IDatabase* databaseConnection =
                DatabaseFactory::getInstance().getDatabase(Scada_SCd/*Scada_Cd*/, Read);
        ...
        {
            std::string text = "DataPointStateChangeAccessFactory Constructor - " + std::string(e.what());
            LOG_EXCEPTION("DatabaseException", text);
        }
