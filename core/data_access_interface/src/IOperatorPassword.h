 ...
 * in any form.
 *
 * Source: $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/IOperatorPassword.h $
 * @author Nick Jardine
 * @version $Revision: #3 $
...
namespace TA_Base_Core
{
    ...
    using IOperatorPasswordPtr = boost::shared_ptr<IOperatorPassword>;
    using IOperatorPasswordPtrList = std::vector<IOperatorPasswordPtr>;
}
