 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/AlarmStateAccessFactory.h $
 * @author:  Xiangmei.lu
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    private:
         ...
         */
        AlarmStateData* createAlarmStateData(ta_uint32 row, IData* data);
    };
} // closes TA_Base_Core
