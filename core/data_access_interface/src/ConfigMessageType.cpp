 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/ConfigMessageType.cpp $
 * @author:  Nick Jardine
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    ta_int32 ConfigMessageType::s_nextAvailableIdentifier = 0;
    ...
    ConfigMessageType::ConfigMessageType(const ta_uint32 row, TA_Base_Core::IData& data)
        :
    ...
    ta_uint32 ConfigMessageType::getUniqueIdentifier()
    {
    ...
    ta_uint32 ConfigMessageType::getKey()
    {
        TA_ASSERT(m_helper != NULL,
                  "Attempt to change state when object has been deleted.");
    ...
    bool ConfigMessageType::isSystemEvent()
    {
        TA_ASSERT(m_helper != NULL,
                  "Attempt to change state when object has been deleted.");

        return m_helper->isSystemEvent();
    }
    ...
    std::string ConfigMessageType::getUnsignedLongAsString(ta_uint32 number)
    {
        char buff[256] = {0};
    ...
    ta_uint32 ConfigMessageType::getUnsignedLongFromString(const std::string& theString)
    {
