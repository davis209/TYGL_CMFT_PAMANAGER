 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/GuiHelper.h $
 * @author:  Karen Graham
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    public:
         ...
         */
        GuiHelper(const ta_uint32 row, TA_Base_Core::IData& data);
    ...
    private:
        ...
        static const ta_uint32 MAX_INSTANCES_LIMIT;
    };
} // closes TA_Base_Core
