 ...
 * in any form.
 *
 * Source: $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/OnlinePrintCfgAccessFactory.h $
 * @author Nick Jardine
 * @version $Revision: #3 $
...
namespace TA_Base_Core
{
    ...
    public:
         ...
         *
         */
        IOnlinePrintCfg* getOnlinePrintCfg(const ta_uint32 idKey, const bool readWrite = false);
