 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/ICombinedEventData.h $
...
namespace TA_Base_Core
{
    ...
    public:
         ...
         */
        virtual const ta_uint64 getKey() = 0;
         ...
         */
        virtual const ta_uint32 getSubsystemKey() = 0;
         ...
         */
        virtual const ta_int32 getPhysicalSubsystemKey() = 0;
         ...
         */
        virtual const ta_uint32 getLocationKey() = 0;
         ...
         */
        virtual const ta_uint32 getSeverityKey() = 0;
         ...
         */
        virtual const ta_uint32 getEventTypeKey() = 0;
         ...
         */
        virtual const ta_uint32 getAlarmTypeKey() = 0;
         ...
         */
        virtual const ta_uint32 getOperatorKey() = 0;
         ...
         */
        virtual const ta_uint32 getEventLevel() = 0;
         ...
         * @return ta_uint32 The location key.
         */
        virtual const ta_uint32 getSessionLocation() = 0;
         ...
         */
        virtual const ta_int32 getProfileId() = 0;
         ...
         */
        virtual const ta_uint32 getActionId() = 0;
         ...
         */
        virtual const ta_uint32 getEntityKey() = 0;
         ...
         */
        virtual const ta_uint32 getSystemKey() = 0;
         ...
         * @return boolean.
         */
        virtual bool getIsSystemEvent() = 0;
    };
    typedef boost::shared_ptr<ICombinedEventData> ICombinedEventDataPtr;
};
