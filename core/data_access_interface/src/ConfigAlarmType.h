 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/ConfigAlarmType.h $
 * @author:  Nick Jardine
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    public:
         ...
         *            either 0 or 1), or if the wrong amount of data is retrieved.
         */
        void setSeverityKey(const ta_uint32 severityKey);
         ...
         *
         * @return The key for this AlarmType as an ta_uint32 .
         */
        ta_uint32 getKey();
         ...
         *
         * @return The key to the severity level of the Alarm type as an ta_uint32 .
         *
         * @exception DatabaseException A DatabaseException will be thrown if there is a
         *            problem establishing a connection with the database, or if an
         *            error is encountered while retrieving data.
         ...
         * getContextKey
         *
         * @return The key of the context for the Alarm type as an ta_uint32 .
         *
         * @exception DatabaseException A DatabaseException will be thrown if there is a
         *            problem establishing a connection with the database, or if an
         *            error is encountered while retrieving data.
        ...
        /**
         *  Gets an ta_uint32 as a string. Use getUnsignedLongFromString
         *  to convert this value back to an ta_uint32 .
         */
        std::string getUnsignedLongAsString(ta_uint32 number);

        /**
         *  Gets an ta_uint32 from a string created using
         *  getUnsignedLongAsString.
         */
        ta_uint32 getUnsignedLongFromString(const std::string& theString);

        /**
         *  Creates a ConfigAlarmType using the given database key.
         */
        ConfigAlarmType(ta_uint32 key);
         ...
         */
        ConfigAlarmType(const ta_uint32 row, TA_Base_Core::IData& data);
    ...
    private:
         ...
         *            the item key is invalid (and this is not a new item).
         */
        std::string getSeverityName(const ta_uint32 key);
