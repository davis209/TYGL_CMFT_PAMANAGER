 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/ConfigProfileGroup.h $
 * @author:  Derrick Liew
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    public:
         ...
         */
        ConfigProfileGroup(const ta_uint32 key);
         ...
         * @param key The key to this profile in the database.
         */
        ConfigProfileGroup(std::string type, const ta_uint32 key);
         ...
         */
        ConfigProfileGroup(const ta_uint32 row, TA_Base_Core::IData& data);
         ...
         */
        bool isGroupUsedInProfile(ta_uint32 key);
    ...
    private:
        ...
        ta_uint32 m_key;
        ta_uint32 m_uniqueIdentifier; // We cannot use keys for identification of profile groups in the
