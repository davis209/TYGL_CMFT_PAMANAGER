 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/ProfileGroupHelper.cpp $
 * @author:  Derrick Liew
 * @version: $Revision: #4 $
 *
...
{
    const ta_uint32 ProfileGroupHelper::DEFAULT_NAME_MAX_LENGTH = 80;
     ...
     */
    ProfileGroupHelper::ProfileGroupHelper(std::string type, ta_uint32 key)
        : m_isValidData(false),
          m_isNew(false),
          m_profileKey(0),
          m_ITSIkey(0),
    ...
    ProfileGroupHelper::ProfileGroupHelper(
        ...
        m_groupType(type)
    {
        FUNCTION_ENTRY("ProfileGroupHelper(const ta_uint32 , TA_Base_Core::IData&)");
    ...
    void ProfileGroupHelper::initialiseMaxFieldLengths()
    {
        ...
        ta_uint32 maxProfileLength = getProfileGroupNameLength();
        ta_uint32 maxITSILength = getITSIGroupNameLength();
    ...
    ta_uint32 ProfileGroupHelper::getProfileGroupNameLength()
    {
        FUNCTION_ENTRY("getProfileGroupNameLength");

        ta_uint32 maxlength(DEFAULT_NAME_MAX_LENGTH);
    ...
    ta_uint32 ProfileGroupHelper::getITSIGroupNameLength()
    {
    ...
    void ProfileGroupHelper::addNewProfileToProfileGroup()
    {
        ...
        LOG_DEBUG("Profile group %s is a new profile group. It will be added to the database.", m_name);
    ...
    void ProfileGroupHelper::addNewProfileToITSIGroup()
    {
        ...
        LOG_DEBUG("Profile group %s is a new ITSI group. It will be added to the database.", m_name);
     ...
     */
    bool ProfileGroupHelper::isGroupUsedInProfile(ta_uint32 key)
    {
    ...
    void ProfileGroupHelper::reloadUsing(const ta_uint32 row, TA_Base_Core::IData& data)
    {
    ...
    void ProfileGroupHelper::modifyExistingProfileGroup()
    {
        ...
        LOG_DEBUG("Profile Group %s already exists. It's data will be updated.", m_name);
    ...
    void ProfileGroupHelper::modifyExistingITSIGroup()
    {
        ...
        LOG_DEBUG("ITSI Group %s already exists. It's data will be updated.", m_name);
