...
namespace TA_Base_Core
{
    ...
    void ModbusServerPointAccessFactory::getAllSubscribedAgents(std::vector<ta_uint32>& vAgentKeys)
    {
        ...
        do
        {
            ...
            for (ta_uint32 i = 0; i < numRows; i++)
            {
                ...
                try
                {
                    ta_uint32 agentKey = data->getUnsignedLongData(i, ModbusServerPoint::ENTITY_AGENTKEY);
