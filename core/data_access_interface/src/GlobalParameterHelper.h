 ...
 * in any form.
 *
 * Source: $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/GlobalParameterHelper.h $
 * @author Karen Graham
 * @version $Revision: #3 $
...
namespace TA_Base_Core
{
    ...
    public:
         ...
         */
        GlobalParameterHelper(const ta_uint32 key);
         ...
         */
        GlobalParameterHelper(const ta_uint32 row, TA_Base_Core::IData& data);
