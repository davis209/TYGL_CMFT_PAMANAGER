 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/ConfigMessageType.h $
 * @author:  Ripple
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    public:
         ...
         *
         * @return The key for this MessageType as an ta_uint32 .
         */
        ta_uint32 getKey();
         ...
         * isSystemEvent
         *
         * Returns whether this message is a system type
         *
         * @returns true if this message is System Type otherwise false
         *
         * @exception DatabaseException A DatabaseException will be thrown if there is a
         *            problem establishing a connection with the database, or if an
         *            error is encountered while retrieving data.
    ...
    public:
         ...
         */
        ConfigMessageType(const ta_uint32 row, TA_Base_Core::IData& data);
