 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/AlarmTypeAccessFactory.cpp $
 * @author:  Nick Jardine
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    IAlarmTypeData* AlarmTypeAccessFactory::getAlarmTypeByKey(ta_uint32 key, const bool readWrite)
    {
        FUNCTION_ENTRY("getAlarmTypeByKey");
    ...
    IConfigAlarmType* AlarmTypeAccessFactory::copyAlarmType(const IConfigAlarmType* alarmTypeToCopy)
    {
