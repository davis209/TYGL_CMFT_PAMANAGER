 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/ConfigLocation.cpp $
 * @author:  Karen Graham
 * @version: $Revision: #3 $
 *
...
{
    ta_int32 ConfigLocation::s_nextAvailableIdentifier = 0;
    ...
    const std::string ConfigLocation::LOCATIONTYPE = "LocationType";
    ...
    ConfigLocation::ConfigLocation(const ta_uint32 key)
    ...
    ConfigLocation::ConfigLocation(const ta_uint32 key, const std::string& name, const std::string& description, const ta_uint32 orderId,
    ...
    ConfigLocation::ConfigLocation(const ta_uint32 row, TA_Base_Core::IData& data)
    ...
    ta_uint32 ConfigLocation::getKey()
    {
        TA_ASSERT(m_locationHelper != NULL, "The location helper is NULL");
    ...
    ta_uint32 ConfigLocation::getOrderId()
    {
        TA_ASSERT(m_locationHelper != NULL, "The location helper is NULL");
    ...
    void ConfigLocation::setOrderId(const ta_uint32 orderId)
    {
        TA_ASSERT(m_locationHelper != NULL, "The location helper is NULL");
    ...
    void ConfigLocation::setLocationType(const std::string &locationType)
    {
        TA_ASSERT(m_locationHelper != NULL, "The location helper is NULL");

        updateLocationChanges(DISPLAYNAME, m_locationHelper->getTypeName(), locationType);

        m_locationHelper->setTypeName(locationType);
    }

    std::string ConfigLocation::getDefaultDisplay(ta_uint32 profileKey, int displayNumber)
    {
        TA_ASSERT(m_locationHelper != NULL, "The location helper is NULL");
    ...
    bool ConfigLocation::isProfileAssociated(ta_uint32 profileId)
    {
        TA_ASSERT(m_locationHelper != NULL, "The location helper is NULL");
