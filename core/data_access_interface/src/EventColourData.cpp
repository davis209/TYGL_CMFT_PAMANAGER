 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/EventColourData.cpp $
 * @author:  Derrick Liew
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
     ...
     */
    EventColourData::EventColourData(const ta_uint32 key)
        : m_helper(new EventColourHelper(key))
    {
    }

    EventColourData::EventColourData(const ta_uint32 row, TA_Base_Core::IData& data)
     ...
     *
     * @return The key for this Event Colour as an ta_uint32 .
     */
    ta_uint32 EventColourData::getKey()
    {
     ...
     *            either 0 or 1), or if the wrong amount of data is retrieved.
     */
    ta_uint32 EventColourData::getEventColourKey(EEventColourType type /*= OPEN_ACKED_FG1*/)
    {
        TA_ASSERT(m_helper != NULL, "The EventColourData helper is NULL");
