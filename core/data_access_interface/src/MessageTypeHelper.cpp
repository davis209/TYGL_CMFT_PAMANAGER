 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/MessageTypeHelper.cpp $
 * @author:  Nick Jardine
 * @version: $Revision: #4 $
 *
...
{
    MessageTypeHelper::MessageTypeHelper(const ta_uint32 row, TA_Base_Core::IData& data)
        :   m_isValidData(false)
    {
        FUNCTION_ENTRY("MessageTypeHelper(const ta_uint32 , TA_Base_Core::IData&)");

        reloadUsing(row, data);
        FUNCTION_EXIT;
    }

    ta_uint32 MessageTypeHelper::getKey()
    {
    ...
    {
        FUNCTION_ENTRY("MessageTypeHelper::setDescription");
    ...
    {
        FUNCTION_ENTRY("MessageTypeHelper::setName");
    ...
    {
        FUNCTION_ENTRY("MessageTypeHelper::setDisplayName");
    ...
    {
        FUNCTION_ENTRY("MessageTypeHelper::setPriority");
    ...
    bool MessageTypeHelper::isSystemEvent()
    {
        if (!m_isValidData)
        {
            reload();
    ...
    ta_uint32 MessageTypeHelper::getActionId()
    {
        if (!m_isValidData)
        {
            reload();
    ...
    {
        FUNCTION_ENTRY("MessageTypeHelper::setPrintMessageStatus");
    ...
    {
        FUNCTION_ENTRY("MessageTypeHelper::setLogMessageStatus");
    ...
    {
        FUNCTION_ENTRY("MessageTypeHelper::setPersistMessageStatus");
    ...
    {
        FUNCTION_ENTRY("MessageTypeHelper::invalidate");
    ...
    {
        FUNCTION_ENTRY("MessageTypeHelper::setViewLevel");
    ...
    void MessageTypeHelper::getColumnNames(std::vector<std::string>& columnNames)
    {
        ...
        columnNames.push_back("ISSYSTEMEVENT");
    ...
    {
        FUNCTION_ENTRY("MessageTypeHelper::reload");
    ...
    void MessageTypeHelper::reloadUsing(const ta_uint32 row, TA_Base_Core::IData& data)
    {
        ...
        unsigned int isSystemEvent = data.getIntegerData(row, columnNames[13]);
        m_isSystemEvent = (1 == isSystemEvent);
    ...
    {
        FUNCTION_ENTRY("MessageTypeHelper::writeMessageTypeData");
    ...
    {
        FUNCTION_ENTRY("MessageTypeHelper::deleteMessageType");
