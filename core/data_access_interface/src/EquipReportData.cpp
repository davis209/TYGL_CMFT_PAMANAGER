 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/EquipReportData.cpp $
 * @author:  Ripple
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    EquipReportData::EquipReportData(const ta_uint32 row, TA_Base_Core::IData& data)
    ...
    ta_uint32 EquipReportData::getKey()
    {
    ...
    ta_uint32 EquipReportData::getDataNodeKey()
    {
        return m_EquipReportDataHelper->getDataNodeKey();
    }

    ta_uint32 EquipReportData::getDataPointKey()
    {
