 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/ProfileGroupAccessFactory.h $
 * @author:  Anita Lee
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    public:
         ...
         */
        IProfileGroup* getProfileGroup(const ta_uint32 ProfileGroupKey, const bool readWrite = false);
