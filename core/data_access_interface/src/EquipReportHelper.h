 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/EquipReportHelper.h $
 * @author:  Ripple
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    public:
        ...
        void setLocationId(const ta_uint32 locationId);
        void setProfile(const ta_uint32 profile);
        ...
        std::string     getName();
        ta_uint32 getKey();
        ta_uint32 getLocationId();
        ta_uint32 getProfile();
        std::string     getId();
        ...
        EquipReportHelper(std::string&  key, const std::string& name, const ta_uint32 locationId);
         ...
         */
        EquipReportHelper(const ta_uint32 row, TA_Base_Core::IData& data);
    ...
    private:
        ...
        ta_uint32 m_LocationId;       // id of the location for this report
        ta_uint32 m_Profile;          // profile of the location for this report
