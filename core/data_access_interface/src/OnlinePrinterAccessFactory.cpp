 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/OnlinePrinterAccessFactory.cpp $
 * @author:  Ripple
 * @version: $Revision: #4 $
 *
...
namespace TA_Base_Core
{
    ...
    void OnlinePrinterAccessFactory::getOnlinePrinterBySql(IDatabase* pDatabase, const SQLStatement& sql, IOnlinePrinters& OnlinePrinters, const bool readWrite)
    {
        ...
        //TA_Base_Core::IDatabase* databaseConnection = DatabaseFactory::getInstance().getDatabase(TA_Base_Core::Ats_Cd, TA_Base_Core::Read);
    ...
    std::vector<OnlinePrinterAccessFactory::SubsystemRecord> OnlinePrinterAccessFactory::getSubsystems()
    {
        ...
        // get a connection to the database
        TA_Base_Core::IDatabase* databaseConnection = DatabaseFactory::getInstance().getDatabase(Event_Ad, TA_Base_Core::Read);
    ...
    IOnlinePrinter* OnlinePrinterAccessFactory::getOnlinePrinter(const ta_uint32 idKey, const bool readWrite)
    {
    ...
    IOnlinePrinters OnlinePrinterAccessFactory::getAllOnlinePrinters(ta_uint32 pLocation, const bool readWrite)
    {
