 ...
 * in any form.
 *
 * Source: $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/ConfigECSStationColourData.h $
 * @author Andy Siow
 * @version $Revision: #3 $
...
namespace TA_Base_Core
{
    ...
    public:
         ...
         *             ta_uint32 ), or if the wrong amount of data is retrieved.
         */
        virtual void setStationColourKey(ta_uint32 colour, EColourType type = IECSStationColourData::CURRENT_PROPOSED_CF);
         ...
         */
        virtual ta_uint32 getStationColourKey(EColourType type);
        ...
        ConfigECSStationColourData(ta_uint32 pkey);
         ...
         */
        ConfigECSStationColourData(const ta_uint32 row, TA_Base_Core::IData& data);
    ...
    private:
         ...
         */
        std::string getHexColourString(ta_uint32 colour);
