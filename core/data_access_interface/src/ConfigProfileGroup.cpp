 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/ConfigProfileGroup.cpp $
 * @author:  Derrick Liew
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    ta_int32 ConfigProfileGroup::s_nextAvailableIdentifier = 0;
     ...
     */
    ConfigProfileGroup::ConfigProfileGroup(const ta_uint32 key)
     ...
     * @param key The key to this profile in the database.
     */
    ConfigProfileGroup::ConfigProfileGroup(std::string type, const ta_uint32 key)
     ...
     */
    ConfigProfileGroup::ConfigProfileGroup(const ta_uint32 row, TA_Base_Core::IData& data)
        :
    ...
    ConfigProfileGroup::~ConfigProfileGroup()
    {
        ...
        {
            LOG_EXCEPTION("Unknown", "Caught failure to destroy ProfileGroupHelper object in destructor");
        }
    }
     ...
     *
     * @return The profile group key for this profile group as an ta_uint32
     */
    ta_uint32 ConfigProfileGroup::getKey()
    {
     ...
     *
     * @param ta_uint32 - The type of profile group
     *
     ...
     */
    bool ConfigProfileGroup::isGroupUsedInProfile(ta_uint32 key)
    {
