 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/GlobalParameter.h $
 * @author:  Karen Graham
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    public:
         ...
         */
        GlobalParameter(const ta_uint32 key);
         ...
         */
        GlobalParameter(const ta_uint32 row, TA_Base_Core::IData& data);
