 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/ConfigGlobalParameter.cpp $
 * @author:  Karen Graham
 * @version: $Revision: #3 $
 *
...
{
    ta_int32 ConfigGlobalParameter::s_nextAvailableIdentifier = 0;
    ...
    ConfigGlobalParameter::ConfigGlobalParameter(const ta_uint32 key)
        : m_GlobalParameterHelper(new GlobalParameterHelper(key)),
          m_uniqueIdentifier(s_nextAvailableIdentifier++)
    {
    }

    ConfigGlobalParameter::ConfigGlobalParameter(const ta_uint32 row, TA_Base_Core::IData& data)
    ...
    ta_uint32 ConfigGlobalParameter::getKey()
    {
        TA_ASSERT(m_GlobalParameterHelper != NULL, "The GlobalParameter helper is NULL");
    ...
    ta_uint32 ConfigGlobalParameter::getSubsystemKey()
    {
        TA_ASSERT(m_GlobalParameterHelper != NULL, "The GlobalParameter helper is NULL");
    ...
    void ConfigGlobalParameter::setSubsystemKey(ta_uint32 subsystemKey)
    {
        TA_ASSERT(m_GlobalParameterHelper != NULL, "The GlobalParameter helper is NULL");
