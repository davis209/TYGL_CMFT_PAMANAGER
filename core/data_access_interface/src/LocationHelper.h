 ...
 * in any form.
 *
 * Source: $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/LocationHelper.h $
 * @author Karen Graham
 * @version $Revision: #3 $
...
namespace TA_Base_Core
{
    ...
    public:
         ...
         */
        LocationHelper(const ta_uint32 key);
         ...
         */
        LocationHelper(const ta_uint32 key, const std::string& name, const std::string& description, const ta_uint32 orderId,
         ...
         */
        LocationHelper(const ta_uint32 row, TA_Base_Core::IData& data);
         ...
         *             ta_uint32 ), or if the wrong ammount of data is retrieved.
         */
        bool isProfileAssociated(ta_uint32 profileId);
    ...
    private:
        ...
        std::vector<ta_uint32> m_associatedProfileKeys;
    };
} // closes TA_Base_Core
