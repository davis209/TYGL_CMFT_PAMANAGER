 ...
 * in any form.
 *
 * Source: $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/ConfigECSStationColourData.cpp $
 * @author Andy Siow
 * @version $Revision: #3 $
...
{
    ta_int32 ConfigECSStationColourData::s_nextAvailableIdentifier = 0;
    ...
    ConfigECSStationColourData::ConfigECSStationColourData(const ta_uint32 key)
        : m_helper(new ECSStationColourHelper(key)),
          m_uniqueIdentifier(s_nextAvailableIdentifier++)
    {
    }

    ConfigECSStationColourData::ConfigECSStationColourData(const ta_uint32 row, TA_Base_Core::IData& data)
        :
    ...
    ta_uint32 ConfigECSStationColourData::getUniqueIdentifier()
    {
    ...
    ta_uint32 ConfigECSStationColourData::getKey()
    {
    ...
    ta_uint32 ConfigECSStationColourData::getStationColourKey(EColourType type)
    {
        TA_ASSERT(m_helper != NULL, "The StationData helper is NULL");
    ...
    void ConfigECSStationColourData::setStationColourKey(ta_uint32 colour, EColourType type)
    {
        TA_ASSERT(m_helper != NULL, "The StationData helper is NULL");
    ...
    std::string ConfigECSStationColourData::getHexColourString(ta_uint32 colour)
    {
    ...
    std::string ConfigECSStationColourData::getUnsignedLongAsString(ta_uint32 number)
    {
        char buff[256] = {0};
    ...
    ta_uint32 ConfigECSStationColourData::getUnsignedLongFromString(const std::string& theString)
    {
