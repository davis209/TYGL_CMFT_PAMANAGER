 ...
 * in any form.
 *
 * Source: $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/ConfigAlarmSeverityData.cpp $
...
{
    ta_int32 ConfigAlarmSeverityData::s_nextAvailableIdentifier = 0;
    ...
    ConfigAlarmSeverityData::ConfigAlarmSeverityData(const ta_uint32 key)
        : m_helper(new AlarmSeverityHelper(key)),
          m_uniqueIdentifier(s_nextAvailableIdentifier++)
    {
    }

    ConfigAlarmSeverityData::ConfigAlarmSeverityData(const ta_uint32 row, TA_Base_Core::IData& data)
    ...
    ta_uint32 ConfigAlarmSeverityData::getUniqueIdentifier()
    {
    ...
    ta_uint32 ConfigAlarmSeverityData::getKey()
    {
    ...
    ta_uint32 ConfigAlarmSeverityData::getSeverityColourKey(EColourType type)
    {
        TA_ASSERT(m_helper != NULL, "The SeverityData helper is NULL");
    ...
    void ConfigAlarmSeverityData::setSeverityColourKey(ta_uint32 colour, EColourType type)
    {
        TA_ASSERT(m_helper != NULL, "The SeverityData helper is NULL");
    ...
    std::string ConfigAlarmSeverityData::getHexColourString(ta_uint32 colour)
    {
    ...
    std::string ConfigAlarmSeverityData::getUnsignedLongAsString(ta_uint32 number)
    {
        char buff[256] = {0};
    ...
    ta_uint32 ConfigAlarmSeverityData::getUnsignedLongFromString(const std::string& theString)
    {
