 ...
 * in any form.
 *
 * Source: $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/IAlarmTypeData.h $
 * @author Nick Jardine
 * @version $Revision: #3 $
...
namespace TA_Base_Core
{
    ...
    public:
         ...
         *            either 0 or 1), or if the wrong amount of data is retrieved.
         */
        virtual ta_uint32 getSeverityKey() = 0;
         ...
         *            either 0 or 1), or if the wrong amount of data is retrieved.
         */
        virtual ta_uint32 getContextKey() = 0;
