 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/ProfileGroupHelper.h $
 * @author:  Derrick Liew
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    public:
         ...
         */
        ProfileGroupHelper(std::string type, ta_uint32 key);
         ...
         */
        ProfileGroupHelper(const std::string& type, const ta_uint32 row, TA_Base_Core::IData& data);
         ...
         *
         * @return All keys for this Profile group as an ta_uint32 .
         *
    ...
    private:
        ...
        ta_uint32 getProfileGroupNameLength();
        ta_uint32 getITSIGroupNameLength();

        static const ta_uint32 DEFAULT_NAME_MAX_LENGTH;
        ta_uint32 m_nameMaxLength;
