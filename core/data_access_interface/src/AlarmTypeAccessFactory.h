 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/AlarmTypeAccessFactory.h $
 * @author:  Nick Jardine
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    public:
         ...
         *            matching the supplied key.
         */
        IAlarmTypeData* getAlarmTypeByKey(ta_uint32 key, const bool readWrite);
