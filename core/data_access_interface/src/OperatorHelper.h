 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/OperatorHelper.h $
 * @author:  Nick Jardine
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    public:
         ...
         */
        OperatorHelper(const ta_uint32 key);
         ...
         *
         */
        OperatorHelper(ta_uint32 row, TA_Base_Core::IData& data, std::vector<ta_uint32>& profiles, std::vector<ta_uint32>& regions);
    ...
    public:
         ...
         *
         * @return The key for this operator as an ta_uint32 .
         *
         ...
         *             ta_uint32 ), or if the wrong ammount of data is retrieved.
         */
        std::string getPassword(const std::string& options = "");
         ...
         * setSALT
         *
         * Sets the S_VAL for this Operator. This should only be used by the ConfigOperator class.
         *
         * @param password The password to give this Operator.
         *
         * pre: This operator has not been deleted
         */
        void setSALT(const std::string strSALT);
         ...
         *             ta_uint32 ), or if the wrong ammount of data is retrieved.
         */
        std::vector<ta_uint32> getAssociatedProfileKeys();
         ...
         * pre: This operator has not been deleted
         */
        void setAssociatedProfile(ta_uint32 profileKey, bool isAssociated);
         ...
         *             ta_uint32 ), or if the wrong ammount of data is retrieved.
         */
        std::vector<ta_uint32> getAssociatedRegionKeys();
    ...
    private:
         ...
         *             - NOT_UNIQUE if the primary key returns multiple records
         */
        void reloadUsing(const ta_uint32 row, TA_Base_Core::IData& data, std::vector<ta_uint32>& profiles, std::vector<ta_uint32>& regions);
         ...
         */
        std::vector<ta_uint32> getProfileKeys();
        ...
        static const ta_uint32 DEFAULT_DESCRIPTION_MAX_LENGTH;
        ...
        std::vector<ta_uint32> m_associatedProfiles;
        std::vector<ta_uint32> m_associatedRegions;
        bool m_isValidData;
        ...
        ta_uint32 m_descriptionMaxLength;
    };
} // closes TA_Base_Core
