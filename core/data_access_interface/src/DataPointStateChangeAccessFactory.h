 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/DataPointStateChangeAccessFactory.h $
 * @author:  Nick Jardine
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    public:
        ...
        std::vector<IDataPointStateChangeData*> getStateChangesBetweenTimes(const time_t fromTime, const time_t toTime = 0,
                                                                            const ta_uint32 maxEvents = 0, StateChangeFilter* filter = NULL, IDatabaseCallbackUser* callbackUser = NULL);
    ...
    private:
        ...
        std::map<std::string, ta_uint32> m_alarmMessageDataPointNameToPKeyMap;
    };
}
