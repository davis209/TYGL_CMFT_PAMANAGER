...
namespace TA_Base_Core
{
    ...
    void NamingPort::loadDataFromDb()
    {
        ...
        ta_uint32 entityKey = data->getUnsignedLongData(0, entityKeyColumn);
        delete data;
        data = NULL;
    ...
    ta_uint32 NamingPort::getPrimaryPort()
    {
    ...
    ta_uint32 NamingPort::getSecondaryPort()
    {
    ...
    ta_uint32 NamingPort::getNsPort(const std::string hostname)
    {
