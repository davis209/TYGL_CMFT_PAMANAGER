 ...
 * in any form.
 *
 * Source: $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/ConfigEventColourData.cpp $
 * @author Derrick Liew
 * @version $Revision: #3 $
...
{
    ta_int32 ConfigEventColourData::s_nextAvailableIdentifier = 0;
    ...
    ConfigEventColourData::ConfigEventColourData(const ta_uint32 key)
        : m_helper(new EventColourHelper(key)),
          m_uniqueIdentifier(s_nextAvailableIdentifier++)
    {
    }

    ConfigEventColourData::ConfigEventColourData(const ta_uint32 row, TA_Base_Core::IData& data)
    ...
    ta_uint32 ConfigEventColourData::getUniqueIdentifier()
    {
    ...
    ta_uint32 ConfigEventColourData::getKey()
    {
    ...
    ta_uint32 ConfigEventColourData::getEventColourKey(EEventColourType type)
    {
        TA_ASSERT(m_helper != NULL, "The EventColourData helper is NULL");
    ...
    void ConfigEventColourData::setEventColourKey(ta_uint32 colour, EEventColourType type)
    {
        TA_ASSERT(m_helper != NULL, "The EventColourData helper is NULL");
    ...
    std::string ConfigEventColourData::getHexColourString(ta_uint32 colour)
    {
    ...
    std::string ConfigEventColourData::getUnsignedLongAsString(ta_uint32 number)
    {
        char buff[256] = {0};
    ...
    ta_uint32 ConfigEventColourData::getUnsignedLongFromString(const std::string& theString)
    {
