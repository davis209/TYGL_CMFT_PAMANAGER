 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/MessageTypeAccessFactory.cpp $
 * @author:  Nick Jardine
 * @version: $Revision: #4 $
 *
...
namespace TA_Base_Core
{
    ...
    std::vector<IMessageTypeData*> MessageTypeAccessFactory::getAllMessageTypes(const bool readWrite, const std::vector<std::string>& eventChannels)
    {
