 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/OperatorPassword.cpp $
 * @author:  Karen Graham
 * @version: $Revision: #3 $
 *
...
{
    OperatorPassword::OperatorPassword(ta_uint32 operatorkey, bool isNew, bool changePassword, bool rightPassword)
        : m_operatorKey(operatorkey),
          ...
          m_isNew(isNew)
    {
        LOG_INFO("OperatorPassword::OperatorPassword");
    }
    ...
    {
        FUNCTION_ENTRY("OperatorPassword::applyChanges");
        ...
        */
        ...
        if (m_isNew)
        {
            LOG_DEBUG("Writing new OPERAOTR_PASSWORD (id: %d) to the database.", m_operatorKey);
            ...
            databaseConnection->prepareSQLStatement(strSql, OPERATOR_PASSWORD_INSERT_74002, 
        ...
        else
        {
            if (m_changePassword)
            {
                ...
                reload();
                LOG_INFO("[2011-11-11] changePassword %d", m_currentPasswdIndicator);
                ...
                LOG_INFO("[2011-11-11] changePassword done %d", m_currentPasswdIndicator);
                databaseConnection->executeModification(strSql);
            }
            ...
            else
            {
                ...
                else
                {
                    ...
                    SQLStatement strSql;
                    reload();
                    LOG_INFO("[2011-11-11] OperatorPassword.cpp=> the m_islockout is %d", m_isPasswordLockout);
    ...
    {
        LOG_INFO("OperatorPassword::setPassword");
        m_password = password;
        m_isUpdateOnly = true;
        m_isNew = true;
    }
