 ...
 * in any form.
 *
 * Source:   $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/IECSStationColourData.h $
 * @author:  Ripple
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Core
{
    ...
    public:
         ...
         */
        virtual ta_uint32 getStationColourKey(EColourType type = CURRENT_PROPOSED_CF) = 0;
