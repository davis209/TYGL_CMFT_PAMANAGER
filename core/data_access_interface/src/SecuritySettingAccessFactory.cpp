...
namespace TA_Base_Core
{
    ...
    {
        LOG_CALLSTACK("SecuritySettingAccessFactory::reload");
    ...
    SecuritySetting SecuritySettingAccessFactory::getSecuritySetting()
    {
        SecuritySetting setting;
        setting.automaticLogoutTime = getAutomaticLogoutTime();
        setting.failedLoginAttemtps = getFailedLoginAttemtps();
        setting.passwordReuseMax = getPasswordReuseMax();
        setting.passwordWarnTime = getPasswordWarnTime();
        setting.passwordReuseTime = getPasswordReuseTime();
        setting.passwordLifeTime = getPasswordLifeTime();
        setting.passwordLockTime = getPasswordLockTime();
        return setting;
    }
