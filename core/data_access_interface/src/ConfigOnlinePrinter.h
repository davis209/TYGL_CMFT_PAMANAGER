 ...
 * in any form.
 *
 * Source: $File: //depot/TYGL_CMFT_TIP/TA_BASE/transactive/core/data_access_interface/src/ConfigOnlinePrinter.h $
 * @author Nick Jardine
 * @version $Revision: #3 $
...
namespace TA_Base_Core
{
    ...
    public:
         ...
         */
        ConfigOnlinePrinter(const ta_uint32 idKey);
         ...
         *
         */
        ConfigOnlinePrinter(ta_uint32 row, TA_Base_Core::IData& data);
    ...
    public:
        ...
        virtual void setLocation(ta_uint32 pSubsystem);
        virtual void setSubsystem(ta_uint32 pSubsystem);
    ...
    private:
        ...
        ta_uint32 m_uniqueIdentifier; // We cannot use keys for identification of guis in the
