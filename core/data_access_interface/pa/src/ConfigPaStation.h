...
namespace TA_IRS_Core
{
    ...
    public:
         ...
         *
         */
        ConfigPaStation(ta_uint32 row, TA_Base_Core::IData& data);
         ...
         */
        ConfigPaStation(const ta_uint32 idKey);
    ...
    public:
         ...
         *
         * @return The key for this PaStation as an ta_uint32 .
         *
         * pre: Either - this PaStation was initially loaded from the database
         *      OR     - writePaStationData() has already been called
       ...
       /**
         ...
         */
        virtual void updatePaStationChanges(const std::string& name, const ta_uint32 oldValue, const ta_uint32 newValue);
		
        // Assignment PaStation not used so it is made private
		ConfigPaStation& operator=(const ConfigPaStation&);


        ta_uint32 m_uniqueIdentifier; // We cannot use keys for identification of PaStations in the
