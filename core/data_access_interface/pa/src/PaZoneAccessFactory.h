...
namespace TA_IRS_Core
{
	...
	public:
         ...
         *
         */
		IPaZone* getPaZone(const ta_uint32 key, 
         ...
         *
         */
        IPaZones getPaZonesByLocationKey(ta_uint32 locationKey, 
                                         const bool readWrite);
         ...
         *
         */
        IPaZones getPaZonesByGroupId(ta_uint32 paZoneGroupKey, 
                                     const bool readWrite);
         ...
         *
         */
        std::list< ta_uint32 > getPaZoneKeysByGroupId(ta_uint32 paZoneGroupKey);
         ...
         *
         */
        std::list< ta_uint32 > getPagingConsolePaZoneKeys();
