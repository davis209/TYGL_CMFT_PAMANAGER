...
namespace TA_IRS_Core
{
    ...
    public:
        ...
        */
         ...
         *
         */
        PaZoneHelper(const ta_uint32 key);
         ...
         *
         */
        PaZoneHelper(ta_uint32 row, TA_Base_Core::IData& data);
         ...
         * @throws DataException
         *         - if the data cannot be converted to the required format 
         *           (e.g. the PA Primary Key should be an ta_uint32 )
         ...
         * @throws DataException
         *         - if the data cannot be converted to the required format 
         *           (e.g. the ID should be an ta_uint32 )
         *         - NO_VALUE if the PaZone record cannot be found for the helper 
         *           constructed with a key.
         *         - NOT_UNIQUE if the key returns multiple records 
         */
         ...
         * @throws DataException
         *         - if the data cannot be converted to the required format 
         *           (e.g. the Status Entity Key should be an ta_uint32 )
         *         - NO_VALUE if the PaZone record cannot be found for the helper 
         *           constructed with a key.
         *         - NOT_UNIQUE if the key returns multiple records 
         *         
         */
        //virtual ta_uint32 getStatusEntityKey();
         ...
         * @throws DataException
         *         - if the data cannot be converted to the required format 
         *           (e.g. Status Entity Key should be an ta_uint32 )
         *         - NO_VALUE if the PaZone record cannot be found for the helper 
         *           constructed with a key.
         *         - NOT_UNIQUE if the key returns multiple records 
         *
        ...
        // virtual void setStatusEntityKey(const ta_uint32 statusEntityKey);
         ...
         * @throws DataException
         *         - if the data cannot be converted to the required format 
         *           (e.g. the PA Location Key should be an ta_uint32 )
         *         - NO_VALUE if the PaZone record cannot be found for the helper 
         *           constructed with a key.
         *         - NOT_UNIQUE if the key returns multiple records 
         */
         ...
         *
         */
        static void associateZoneWithEquipmentEntity(ta_uint32 zoneKey,
    ...
    private:
         ...
         *
         */
        static void validateNewZoneEntityNameUniqueness(ta_uint32 zoneKey,
                                                        const std::string& entityName);
        ...
        TA_Base_Core::PrimitiveWrapper< ta_uint32 > m_id;                 // Mustn't be 'unset', all table columns non null
  		std::string                     m_label;
        //PrimitiveWrapper< ta_uint32 > m_statusEntityKey;    // Mustn't be 'unset', all table columns non null
