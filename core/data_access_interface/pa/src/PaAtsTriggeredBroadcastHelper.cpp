/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/TYGL_CMFT_TIP/J155/transactive/core/data_access_interface/pa/src/PaAtsTriggeredBroadcastHelper.cpp $
  * @author:  Jade Lee
  * @version: $Revision: #3 $
  *
...
namespace TA_IRS_Core
{
    ...
    PaAtsTriggeredBroadcastHelper::PaAtsTriggeredBroadcastHelper(const ta_uint32 key)
        : m_key(key),		  
          m_dateCreated(0),
          m_dateModified(0),
          m_isValidData(false),
    ...
    PaAtsTriggeredBroadcastHelper::PaAtsTriggeredBroadcastHelper(ta_uint32 row, TA_Base_Core::IData& data)
    ...
    ta_uint32 PaAtsTriggeredBroadcastHelper::getKey()
    {
    ...
    ta_uint32 PaAtsTriggeredBroadcastHelper::getAtsEventType()
    {
    ...
    ta_uint32 PaAtsTriggeredBroadcastHelper::getLocationKey()
    {
    ...
    ta_uint32 PaAtsTriggeredBroadcastHelper::getDestinationLocationKey()
    {
    ...
    ta_uint32 PaAtsTriggeredBroadcastHelper::getPlatformId()
    {
    ...
    ta_uint32 PaAtsTriggeredBroadcastHelper::getPaZoneGroupKey()
    {
    ...
    ta_uint32 PaAtsTriggeredBroadcastHelper::getPaDvaMessageKey()
    {
    ...
    void PaAtsTriggeredBroadcastHelper::setAtsEventType(ta_uint32 eventType)
    {
    ...
    void PaAtsTriggeredBroadcastHelper::setLocationKey(const ta_uint32 locationKey)
    {
    ...
    void PaAtsTriggeredBroadcastHelper::setDestinationLocationKey(ta_uint32 key)
    {
    ...
    void PaAtsTriggeredBroadcastHelper::setPlatformId(ta_uint32 platformId)
    {
    ...
    void PaAtsTriggeredBroadcastHelper::setPaZoneGroupKey(ta_uint32 key)
    {
    ...
    void PaAtsTriggeredBroadcastHelper::setPaDvaMessageKey(ta_uint32 key)
    {
    ...
    void PaAtsTriggeredBroadcastHelper::reloadUsing(ta_uint32 row, TA_Base_Core::IData& data)
    {
    ...
    void PaAtsTriggeredBroadcastHelper::writePaAtsTriggeredBroadcastData() 
    {       
    ...
    void PaAtsTriggeredBroadcastHelper::modifyExistingPaAtsTriggeredBroadcast() 
    {
    ...
    void PaAtsTriggeredBroadcastHelper::addNewPaAtsTriggeredBroadcast()
    {
        ...
        ta_uint32 sequenceNumber = DatabaseQueryHelper::getNextSequenceNumber(
                                                                databaseConnection,
        ...
        // Retrieve the pkey as an ta_uint32 . There should only be a single returned item 
    ...
    void PaAtsTriggeredBroadcastHelper::validateLocationKeyExistence()
    {
        ////////////////////////////////////////////////////////////////////////////
        //
