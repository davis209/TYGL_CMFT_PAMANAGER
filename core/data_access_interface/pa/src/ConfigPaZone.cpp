...
{
    ta_int32 ConfigPaZone::s_nextAvailableIdentifier = 0;
    ...
    ConfigPaZone::ConfigPaZone(ta_uint32 row, TA_Base_Core::IData& data)
    ...
    ConfigPaZone::ConfigPaZone(const ta_uint32 key)
    ...
    void ConfigPaZone::setLocationKey(const ta_uint32 locationKey)
    {
    ...
    void ConfigPaZone::setId(const ta_uint32 id)
    {
    ...
    /*
    void ConfigPaZone::setStatusEntityKey(const ta_uint32 statusEntityKey)
    {
    ...
    */
    ...
    ta_uint32 ConfigPaZone::getKey()
    {
        TA_ASSERT(m_paZoneHelper != NULL,"The PaZoneHelper pointer is null.");
        return m_paZoneHelper->getKey();
    }

    ta_uint32 ConfigPaZone::getLocationKey()
    {
        TA_ASSERT(m_paZoneHelper != NULL,"The PaZoneHelper pointer is null.");
        return m_paZoneHelper->getLocationKey();
    }

    ta_uint32 ConfigPaZone::getId()
    {
        TA_ASSERT(m_paZoneHelper != NULL,"The PaZoneHelper pointer is null.");
    ...
    /*
    ta_uint32 ConfigPaZone::getStatusEntityKey()
    {
        TA_ASSERT(m_paZoneHelper != NULL,"The PaZoneHelper pointer is null.");
    ...
    */
    ...
    void ConfigPaZone::updatePaZoneChanges(const std::string& name, const ta_uint32 oldValue, const ta_uint32 newValue)
    {
