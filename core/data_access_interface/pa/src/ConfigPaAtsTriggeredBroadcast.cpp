...
{
    ta_int32 ConfigPaAtsTriggeredBroadcast::s_nextAvailableIdentifier = 0;
    ...
    ConfigPaAtsTriggeredBroadcast::ConfigPaAtsTriggeredBroadcast(ta_uint32 row, TA_Base_Core::IData& data)
    ...
    ConfigPaAtsTriggeredBroadcast::ConfigPaAtsTriggeredBroadcast(const ta_uint32 key)
    ...
    void ConfigPaAtsTriggeredBroadcast::setAtsEventType(ta_uint32 eventType)
    {    
    ...
    void ConfigPaAtsTriggeredBroadcast::setLocationKey(ta_uint32 locationKey)
    {
    ...
    void ConfigPaAtsTriggeredBroadcast::setDestinationLocationKey(ta_uint32 key)
    {
    ...
    void ConfigPaAtsTriggeredBroadcast::setPlatformId(ta_uint32 platformId)
    {
    ...
    void ConfigPaAtsTriggeredBroadcast::setPaZoneGroupKey(ta_uint32 key)
    {
    ...
    void ConfigPaAtsTriggeredBroadcast::setPaDvaMessageKey(ta_uint32 key)
    {
    ...
    ta_uint32 ConfigPaAtsTriggeredBroadcast::getKey()
    {
        TA_ASSERT(m_paAtsTriggeredBroadcastHelper != NULL,"The PaAtsTriggeredBroadcastHelper pointer is null.");
    ...
    ta_uint32 ConfigPaAtsTriggeredBroadcast::getAtsEventType()
    {
        TA_ASSERT(m_paAtsTriggeredBroadcastHelper != NULL,"The PaAtsTriggeredBroadcastHelper pointer is null.");
    ...
    ta_uint32 ConfigPaAtsTriggeredBroadcast::getLocationKey()
    {
        TA_ASSERT(m_paAtsTriggeredBroadcastHelper != NULL,"The PaAtsTriggeredBroadcastHelper pointer is null.");
    ...
    ta_uint32 ConfigPaAtsTriggeredBroadcast::getDestinationLocationKey()
    {
        TA_ASSERT(m_paAtsTriggeredBroadcastHelper != NULL,"The PaAtsTriggeredBroadcastHelper pointer is null.");
    ...
    ta_uint32 ConfigPaAtsTriggeredBroadcast::getPlatformId()
    {
        TA_ASSERT(m_paAtsTriggeredBroadcastHelper != NULL,"The PaAtsTriggeredBroadcastHelper pointer is null.");
    ...
    ta_uint32 ConfigPaAtsTriggeredBroadcast::getPaZoneGroupKey()
    {
        TA_ASSERT(m_paAtsTriggeredBroadcastHelper != NULL,"The PaAtsTriggeredBroadcastHelper pointer is null.");
    ...
    ta_uint32 ConfigPaAtsTriggeredBroadcast::getPaDvaMessageKey()
    {
        TA_ASSERT(m_paAtsTriggeredBroadcastHelper != NULL,"The PaAtsTriggeredBroadcastHelper pointer is null.");
    ...
    void ConfigPaAtsTriggeredBroadcast::updatePaAtsTriggeredBroadcastChanges(const std::string& name, const ta_uint32 oldValue, const ta_uint32 newValue)
    {
