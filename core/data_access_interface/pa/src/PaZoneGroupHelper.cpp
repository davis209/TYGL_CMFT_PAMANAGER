...
namespace TA_IRS_Core
{
    ...
    PaZoneGroupHelper::PaZoneGroupHelper(const ta_uint32 key)
        : m_key(key),		  
          m_label(""),
    ...
    PaZoneGroupHelper::PaZoneGroupHelper(ta_uint32 row, TA_Base_Core::IData& data)
    ...
    ta_uint32 PaZoneGroupHelper::getKey()
    {
    ...
    ta_uint32 PaZoneGroupHelper::getLocationKey()
    {
    ...
    void PaZoneGroupHelper::setLocationKey(const ta_uint32 locationKey)
    {
    ...
    ta_uint32 PaZoneGroupHelper::getIsEventGroup()
    {
    ...
    void PaZoneGroupHelper::setIsEventGroup(const ta_uint32 isEventGroup)
    {
    ...
    void PaZoneGroupHelper::reloadUsing(ta_uint32 row, TA_Base_Core::IData& data)
    {               
    ...
    {   
        ...
        {        
            ta_uint32 duplicateItemKey = data->getUnsignedLongData(0, KEY_COL);
    ...
    void PaZoneGroupHelper::addNewPaZoneGroupUsingKey(TA_Base_Core::IDatabase* databaseConnection, ta_uint32 keyToUse)
    {
    ...
    void PaZoneGroupHelper::destroyGroupZoneAssociations(ta_uint32 groupKey)
    {
    ...
    void PaZoneGroupHelper::associateGroupWithZones(ta_uint32 groupKey,
                                                    const std::list< ta_uint32 >& zoneKeys)
    {
        TA_Base_Core::IDatabase* databaseConnection = 
                    TA_Base_Core::DatabaseFactory::getInstance().getDatabase(TA_Base_Core::Pa_Cd, TA_Base_Core::Write);
        ...
        for (std::list< ta_uint32 >::const_reverse_iterator it = zoneKeys.rbegin(); 
                            it != zoneKeys.rend(); 
                            it ++)
        {
            ta_uint32 zoneKey = (*it);
    ...
    void PaZoneGroupHelper::removeGroupZoneAssociations(ta_uint32 groupKey,
                                                        const std::list< ta_uint32 >& zoneKeys)
    {
    ...
    void PaZoneGroupHelper::validateNewGroupIdZoneKeyUniqueness(ta_uint32 groupId,
                                                                ta_uint32 zoneKey)
    {   
        std::ostringstream sql;
        ...
        if (0 != data->getNumRows()) 
        {        
            ta_uint32 duplicateItemKey = data->getUnsignedLongData(0, PA_ZONE_GROUP_HELPER_KEY_COL);
