...
namespace TA_IRS_Core
{
    ...
    public:
         ...
         *
         */
        PaDvaMessageHelper(const ta_uint32 key);
         ...
         *
         */
        PaDvaMessageHelper(ta_uint32 row, TA_Base_Core::IData& data);
    ...
    private:
        ...
        TA_Base_Core::PrimitiveWrapper< ta_uint32 > m_id;                 // Mustn't be 'unset', all table columns non null
  		std::string m_label;
        std::string m_type;
        TA_Base_Core::PrimitiveWrapper< ta_uint32 > m_tisMessageTag;    // Allowed to be null
        TA_Base_Core::PrimitiveWrapper< ta_uint32 > m_tisLibrarySection;    // Allowed to be null
        TA_Base_Core::PrimitiveWrapper< ta_uint32 > m_tisLibraryVersion;    // Null allowed
