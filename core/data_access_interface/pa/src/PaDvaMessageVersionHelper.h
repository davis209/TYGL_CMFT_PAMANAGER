...
namespace TA_IRS_Core
{
    ...
    public:
         ...
         *
         */
        PaDvaMessageVersionHelper(const ta_uint32 key);
         ...
         *
         */
        PaDvaMessageVersionHelper(ta_uint32 row, TA_Base_Core::IData& data);
    ...
    private:
         ...
         *
         */
        std::string getMessageVersionUsingParams(ta_uint32 stationDvaMessageId,
