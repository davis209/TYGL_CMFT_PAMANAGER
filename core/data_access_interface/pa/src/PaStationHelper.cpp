/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/TYGL_CMFT_TIP/J155/transactive/core/data_access_interface/pa/src/PaStationHelper.cpp $
  * @author:  Jade Lee
  * @version: $Revision: #3 $
  *
...
namespace TA_IRS_Core
{
    ...
    PaStationHelper::PaStationHelper(const ta_uint32 key)
        : m_key(key),		  
		  // m_locationKey(0),          
          m_dateCreated(0),
          m_dateModified(0),
    ...
    PaStationHelper::PaStationHelper(ta_uint32 row, TA_Base_Core::IData& data)
    ...
    ta_uint32 PaStationHelper::getKey()
    {
    ...
    ta_uint32 PaStationHelper::getLocationKey()
    {
    ...
    void PaStationHelper::setLocationKey(const ta_uint32 locationKey)
    {
    ...
    void PaStationHelper::setKey(const ta_uint32 id)
    {
    ...
    void PaStationHelper::reloadUsing(ta_uint32 row, TA_Base_Core::IData& data)
    {
    ...
    void PaStationHelper::writePaStationData()
    {       
    ...
    void PaStationHelper::modifyExistingPaStation()
    {
        ...
        ta_uint32 updatedKeyVal = m_key.getValue();
    ...
    void PaStationHelper::addNewPaStation()
    {
    ...
    void PaStationHelper::validateLocationKeyExistence()
    {
        ////////////////////////////////////////////////////////////////////////////
        //
    ...
    void PaStationHelper::validateKeyExistence()
    {
    ...
    void PaStationHelper::validateKeyAbsence()
    {
    ...
    void PaStationHelper::setKeyToUse(ta_uint32 keyToUse)
    {
    ...
    ta_uint32 PaStationHelper::getModifiedKey()
    {
        if (m_modifiedKey.hasBeenSet())
        {
    ...
    bool PaStationHelper::isKeyDuplicate(ta_uint32 keyToUse)
    {
