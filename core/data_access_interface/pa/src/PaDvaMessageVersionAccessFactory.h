...
namespace TA_IRS_Core
{
	...
	public:
         ...
         *
         */
		IPaDvaMessageVersion* getPaDvaMessageVersion(const ta_uint32 key, const bool readWrite);
         ...
         *
         */
		IPaDvaMessageVersion* getPaDvaMessageVersionByLocationKey(const ta_uint32 locationKey, const bool readWrite);
