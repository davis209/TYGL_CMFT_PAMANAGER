...
namespace TA_IRS_Core
{
    ...
    public:
         ...
         *
         */
        PaZoneGroupHelper(const ta_uint32 key);
         ...
         *
         */
        PaZoneGroupHelper(ta_uint32 row, TA_Base_Core::IData& data);
         ...
         * @throws DataException
         *         - if the data cannot be converted to the required format 
         *           (e.g. the IsEventGroup property should be an ta_uint32 )
         *         - NO_VALUE if the PaZoneGroup record cannot be found for the helper 
         *           constructed with a key.
         *         - NOT_UNIQUE if the key returns multiple records 
         *         
         ...
         * @throws DataException
         *         - if the data cannot be converted to the required format 
         *           (e.g. IsEventGroup variable should be an ta_uint32 )
         *         - NO_VALUE if the PaZoneGroup record cannot be found for the helper 
         *           constructed with a key.
         *         - NOT_UNIQUE if the key returns multiple records 
         *
         ...
         *
         */
        static void associateGroupWithZones(ta_uint32 groupKey,
         ...
         *
         */
        static void removeGroupZoneAssociations(ta_uint32 groupKey,
                                                const std::list< ta_uint32 >& zoneKeys);
         ...
         *
         */
        void destroyGroupZoneAssociations(ta_uint32 groupKey);
    ...
    private:
         ...
         *
         */
        static void validateNewGroupIdZoneKeyUniqueness(ta_uint32 groupId,
                                                        ta_uint32 zoneKey);
         ...
         *
         */
        void addNewPaZoneGroupUsingKey(TA_Base_Core::IDatabase* databaseConnection, ta_uint32 keyToUse);
		...
		ta_uint32 m_copiedKey;
		bool          m_isCopiedKeySet;
		// ++marvin TD8110
        
        TA_Base_Core::PrimitiveWrapper< ta_uint32 > m_locationKey;     // Mustn't be 'unset', all table columns non null
        std::string m_label;
        // Mustn't be 'unset', all table columns non null (but this does default to 0)
        TA_Base_Core::PrimitiveWrapper< ta_uint32 > m_isEventGroup;    
