...
namespace TA_IRS_Core
{
	...
	public:
         ...
         *            3) Error while attempting to execute a database query
         */
        void setLibraryVersion(ta_uint32 libraryVersion);
         ...
         *
         */
		IPaTrainDvaMessage* getPaTrainDvaMessage(const ta_uint32 key, const bool readWrite);
         ...
         *
         */
		IConfigPaTrainDvaMessage* createPaTrainDvaMessage(ta_uint32 primaryKey);
