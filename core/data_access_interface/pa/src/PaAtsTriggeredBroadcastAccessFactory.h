...
namespace TA_IRS_Core
{
	...
	public:
         ...
         *
         */
		IPaAtsTriggeredBroadcast* getPaAtsTriggeredBroadcast(const ta_uint32 key, const bool readWrite);
         ...
         *
         */
        IPaAtsTriggeredBroadcasts getPaAtsTriggeredBroadcastsByLocationKey(ta_uint32 locationKey, const bool readWrite = false );
