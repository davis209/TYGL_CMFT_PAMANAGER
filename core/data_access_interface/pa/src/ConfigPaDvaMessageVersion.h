...
namespace TA_IRS_Core
{
    ...
    public:
         ...
         *
         */
        ConfigPaDvaMessageVersion(ta_uint32 row, TA_Base_Core::IData& data);
         ...
         */
        ConfigPaDvaMessageVersion(const ta_uint32 idKey);
    ...
    public:
         ...
         *
         * @return The key for this PaDvaMessageVersion as an ta_uint32 .
         *
         * pre: Either - this PaDvaMessageVersion was initially loaded from the database
         *      OR     - writePaDvaMessageVersionData() has already been called
        ...
        virtual std::string getMessageVersion(IPaDvaMessageVersion::ELocation location, ta_uint32 stationDvaMessageId);
        virtual std::string getVersionData(EVersionColumn column);

        virtual void setLocationKey(ta_uint32 key);
    ...
    private:
         ...
         */
        virtual void updatePaDvaMessageVersionChanges(const std::string& name, const ta_uint32 oldValue, const ta_uint32 newValue);
        ...
        ta_uint32 m_uniqueIdentifier; // We cannot use keys for identification of PaDvaMessageVersions in the
