...
namespace TA_IRS_Core
{
    ...
    IPaZoneGroup* PaZoneGroupAccessFactory::getPaZoneGroup(const ta_uint32 key,const bool readWrite)
    {
    ...
    IPaZoneGroups PaZoneGroupAccessFactory::getPaZoneGroupsByLocationKey(ta_uint32 locationKey, const bool readWrite )
    {
        std::ostringstream sql;
