...
namespace TA_IRS_Core
{
	...
	public:
         ...
         *
         */
		IPaZoneGroup* getPaZoneGroup(const ta_uint32 key, const bool readWrite);
         ...
         *
         */
        IPaZoneGroups getPaZoneGroupsByLocationKey(ta_uint32 locationKey, const bool readWrite = false );
