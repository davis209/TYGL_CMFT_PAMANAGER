...
namespace TA_IRS_Core
{
    ...
    public:
         ...
         *
         */
        PaTrainDvaMessageHelper(const ta_uint32 key);
         ...
         *
         */
        PaTrainDvaMessageHelper(ta_uint32 row, TA_Base_Core::IData& data);
         ...
         *
         */
        static void validateKeyUniqueness(ta_uint32 keyToTest); 
    ...
    private:
         ...
         *
         */
        void addNewPaTrainDvaMessage(ta_uint32 keyToUse); //throw(TA_Core::TransactiveException);
