...
{
    ta_int32 ConfigPaStation::s_nextAvailableIdentifier = 0;
    ...
    ConfigPaStation::ConfigPaStation(ta_uint32 row, TA_Base_Core::IData& data)
    ...
    ConfigPaStation::ConfigPaStation(const ta_uint32 key)
    ...
    void ConfigPaStation::setLocationKey(const ta_uint32 locationKey)
    {
    ...
    void ConfigPaStation::setKey(const ta_uint32 id)
    {
    ...
    ta_uint32 ConfigPaStation::getLocationKey()
    {
        TA_ASSERT(m_paStationHelper != NULL,"The PaStationHelper pointer is null.");
        return m_paStationHelper->getLocationKey();
    }

    ta_uint32 ConfigPaStation::getKey()
    {
        TA_ASSERT(m_paStationHelper != NULL,"The PaStationHelper pointer is null.");
    ...
    void ConfigPaStation::updatePaStationChanges(const std::string& name, const ta_uint32 oldValue, const ta_uint32 newValue)
    {
    ...
    ta_uint32 ConfigPaStation::getModifiedKey()
    {
