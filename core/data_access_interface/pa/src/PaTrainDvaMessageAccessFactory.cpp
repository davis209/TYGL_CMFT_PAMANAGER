...
namespace TA_IRS_Core
{
    ...
    ta_uint32 PaTrainDvaMessageAccessFactory::getLibraryVersion()
    {
        ...
        ta_uint32 libraryVersion= data->getUnsignedLongData(0, LIBRARY_VERSION_COL_NAME);
    ...
    void PaTrainDvaMessageAccessFactory::setLibraryVersion(ta_uint32 libraryVersion)
    {
        // get a connection to the database
        TA_Base_Core::IDatabase* databaseConnection = 
    ...
    IPaTrainDvaMessage* PaTrainDvaMessageAccessFactory::getPaTrainDvaMessage(const ta_uint32 key,const bool readWrite)
    {
        // get a connection to the database
        TA_Base_Core::IDatabase* databaseConnection = 
                TA_Base_Core::DatabaseFactory::getInstance().getDatabase(TA_Base_Core::Pa_Cd, TA_Base_Core::Read);
    ...
    IConfigPaTrainDvaMessage* PaTrainDvaMessageAccessFactory::createPaTrainDvaMessage(ta_uint32 primaryKey)
    {      
