...
namespace TA_IRS_Core
{
	...
	public:
         ...
         *
         */
		IPaStation* getPaStation(const ta_uint32 key, const bool readWrite);
         ...
         *
         */
        IPaStations getPaStationsByLocationKey(ta_uint32 locationKey, const bool readWrite = false );
