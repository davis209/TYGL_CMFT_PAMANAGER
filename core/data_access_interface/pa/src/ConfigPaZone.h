...
namespace TA_IRS_Core
{
    ...
    public:
         ...
         *
         */
        ConfigPaZone(ta_uint32 row, TA_Base_Core::IData& data);
         ...
         */
        ConfigPaZone(const ta_uint32 idKey);
    ...
    public:
         ...
         *
         * @param ta_uint32 - This is the key of the StationMode to add or remove from the associations
         ...
         *
         * @return The key for this PaZone as an ta_uint32 .
         *
         * pre: Either - this PaZone was initially loaded from the database
         *      OR     - writePaZoneData() has already been called
    ...
    private:
         ...
         */
        virtual void updatePaZoneChanges(const std::string& name, const ta_uint32 oldValue, const ta_uint32 newValue);
		
        // Assignment PaZone not used so it is made private
		ConfigPaZone& operator=(const ConfigPaZone&);


        ta_uint32 m_uniqueIdentifier; // We cannot use keys for identification of PaZones in the
