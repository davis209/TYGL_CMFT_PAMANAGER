...
namespace TA_IRS_Core
{
    ...
    public:
         ...
         *
         */
        PaAtsTriggeredBroadcastHelper(const ta_uint32 key);
         ...
         *
         */
        PaAtsTriggeredBroadcastHelper(ta_uint32 row, TA_Base_Core::IData& data);
         ...
         * @throws DataException
         *         - if the data cannot be converted to the required format 
         *           (e.g. the key should be an ta_uint32 )
         ...
         * @throws DataException
         *         - if the data cannot be converted to the required format 
         *           (e.g. ATS Event Type should be an ta_uint32 )
         *         - NO_VALUE if the PaAtsTriggeredBroadcast record cannot be found for the helper 
         *           constructed with a key.
         *         - NOT_UNIQUE if the key returns multiple records 
         */
         ...
         * @throws DataException
         *         - if the data cannot be converted to the required format 
         *           (e.g. Location Key should be an ta_uint32 )
         *         - NO_VALUE if the PaAtsTriggeredBroadcast record cannot be found for the helper 
         *           constructed with a key.
         *         - NOT_UNIQUE if the key returns multiple records 
         */
         ...
         * @throws DataException
         *         - if the data cannot be converted to the required format 
         *           (e.g. Destination Location Key should be an ta_uint32 )
         *         - NO_VALUE if the PaAtsTriggeredBroadcast record cannot be found for the helper 
         *           constructed with a key.
         *         - NOT_UNIQUE if the key returns multiple records 
         */
         ...
         * @throws DataException
         *         - if the data cannot be converted to the required format 
         *           (e.g. Platform ID should be an ta_uint32 )
         *         - NO_VALUE if the PaAtsTriggeredBroadcast record cannot be found for the helper 
         *           constructed with a key.
         *         - NOT_UNIQUE if the key returns multiple records 
         */
         ...
         * @throws DataException
         *         - if the data cannot be converted to the required format 
         *           (e.g. PA Zone Group foreign key should be an ta_uint32 )
         *         - NO_VALUE if the PaAtsTriggeredBroadcast record cannot be found for the helper 
         *           constructed with a key.
         *         - NOT_UNIQUE if the key returns multiple records 
         */
         ...
         * @throws DataException
         *         - if the data cannot be converted to the required format 
         *           (e.g. PA DVA Message foreign key should be an ta_uint32 )
         *         - NO_VALUE if the PaAtsTriggeredBroadcast record cannot be found for the helper 
         *           constructed with a key.
         *         - NOT_UNIQUE if the key returns multiple records 
         */
         ...
         *
         */
        virtual void setAtsEventType(const ta_uint32 eventType);
         ...
         *
         */
        virtual void setDestinationLocationKey(const ta_uint32 key);
         ...
         *
         */
        virtual void setPlatformId(const ta_uint32 platformId);
         ...
         * @throws DataException
         *         - if the data cannot be converted to the required format 
         *           (e.g. Is Last Train State should be an ta_uint32 )
         *         - NO_VALUE if the PaAtsTriggeredBroadcast record cannot be found for the helper 
         *           constructed with a key.
         *         - NOT_UNIQUE if the key returns multiple records 
         *
         ...
         *
         */
        virtual void setPaZoneGroupKey(const ta_uint32 key);
         ...
         *
         */
        virtual void setPaDvaMessageKey(const ta_uint32 key);
         ...
         * @throws DataException
         *         - if the data cannot be converted to the required format 
         *           (e.g. Is Enabled Parameter State should be an ta_uint32 )
         *         - NO_VALUE if the PaAtsTriggeredBroadcast record cannot be found for the helper 
         *           constructed with a key.
         *         - NOT_UNIQUE if the key returns multiple records 
         *
         ...
         * @throws DataException
         *         - if the data cannot be converted to the required format 
         *           (e.g. the Location Key should be an ta_uint32 )
         *         - NO_VALUE if the PaAtsTriggeredBroadcast record cannot be found for the helper 
         *           constructed with a key.
         *         - NOT_UNIQUE if the key returns multiple records 
         */
    ...
    protected:
         ...
         *
         */
        virtual void reloadUsing(ta_uint32 row, TA_Base_Core::IData& data);
    ...
    private:
         ...
         *
         */
        virtual ta_uint32 getKeyDirect() const { return m_key; }


        ta_uint32 m_key;
        
        // none of the values can be null
        TA_Base_Core::PrimitiveWrapper< ta_uint32 > m_atsEventType;
        TA_Base_Core::PrimitiveWrapper< ta_uint32 > m_locationKey;    
        TA_Base_Core::PrimitiveWrapper< ta_uint32 > m_destinationLocationKey;  
        TA_Base_Core::PrimitiveWrapper< ta_uint32 > m_platformId;

        TA_Base_Core::PrimitiveWrapper<bool> m_isLastTrain;    
        TA_Base_Core::PrimitiveWrapper< ta_uint32 > m_paZoneGroupKey;    
        TA_Base_Core::PrimitiveWrapper< ta_uint32 > m_paDvaMessageKey;    
