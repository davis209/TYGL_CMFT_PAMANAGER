...
namespace TA_IRS_Core
{
    ...
    public:
        ...
        struct TisMessage
        {
            TisMessage();
            ta_uint32 pKey;
            ta_uint32 tisMessageTag;
            ta_uint32 tisLibrarySection;
            ta_uint32 tisLibraryVersion;
	...
	public:
         ...
         *
         */
		IPaDvaMessage* getPaDvaMessage(const ta_uint32 key, const bool readWrite);
         ...
         *
         */
        IPaDvaMessages getPaDvaMessagesByLocationKey(ta_uint32 locationKey, const bool readWrite = false );
