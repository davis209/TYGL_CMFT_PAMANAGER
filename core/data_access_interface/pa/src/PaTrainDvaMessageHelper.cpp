/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/TYGL_CMFT_TIP/J155/transactive/core/data_access_interface/pa/src/PaTrainDvaMessageHelper.cpp $
  * @author:  Jade Lee
  * @version: $Revision: #3 $
  *
...
namespace TA_IRS_Core
{
    ...
    PaTrainDvaMessageHelper::PaTrainDvaMessageHelper(const ta_uint32 key)
        : m_key(key),		  
          m_label(""),
          m_dateCreated(0),
          m_dateModified(0),
    ...
    PaTrainDvaMessageHelper::PaTrainDvaMessageHelper(ta_uint32 row, TA_Base_Core::IData& data)
    ...
    ta_uint32 PaTrainDvaMessageHelper::getKey()
    {
    ...
    ta_uint32 PaTrainDvaMessageHelper::getModifiedKey()
    {
    ...
    void PaTrainDvaMessageHelper::setKeyToUse(ta_uint32 keyToUse)
    {
    ...
    void PaTrainDvaMessageHelper::reloadUsing(ta_uint32 row, TA_Base_Core::IData& data)
    {
    ...
    void PaTrainDvaMessageHelper::writePaTrainDvaMessageData()
    {       
    ...
    void PaTrainDvaMessageHelper::validateKeyUniqueness(ta_uint32 keyToUse)
    {   
    ...
    bool PaTrainDvaMessageHelper::isKeyDuplicate(ta_uint32 keyToUse)
    {
    ...
    void PaTrainDvaMessageHelper::modifyExistingPaTrainDvaMessage()
    {
    ...
    void PaTrainDvaMessageHelper::addNewPaTrainDvaMessage(ta_uint32 keyToUse) 
    {
