...
namespace TA_IRS_Core
{
    ...
    public:
         ...
         *
         */
        ConfigPaTrainDvaMessage(ta_uint32 row, TA_Base_Core::IData& data);
         ...
         */
        ConfigPaTrainDvaMessage(const ta_uint32 idKey);
         ...
         *
         */
        void    setKeyForNewMessage(ta_uint32 key);
    ...
    public:
         ...
         *
         * @return The key for this PaTrainDvaMessage as an ta_uint32 .
         *
         * pre: Either - this PaTrainDvaMessage was initially loaded from the database
         *      OR     - writePaTrainDvaMessageData() has already been called
       ...
       /**
         ...
         */
        virtual ta_uint32 getModifiedKey();
    ...
    private:
         ...
         */
        virtual void updatePaTrainDvaMessageChanges(const std::string& name, const ta_uint32 oldValue, const ta_uint32 newValue);
        ...
        ta_uint32 m_uniqueIdentifier; // We cannot use keys for identification of PaTrainDvaMessages in the
