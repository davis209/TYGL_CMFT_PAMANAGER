...
namespace TA_IRS_Core
{
    ...
    public:
         ...
         *
         */
        ConfigPaAtsTriggeredBroadcast(ta_uint32 row, TA_Base_Core::IData& data);
         ...
         */
        ConfigPaAtsTriggeredBroadcast(const ta_uint32 idKey);
    ...
    public:
         ...
         *
         * @return The key for this PaAtsTriggeredBroadcast as an ta_uint32 .
         *
         * pre: Either - this PaAtsTriggeredBroadcast was initially loaded from the database
         *      OR     - writePaAtsTriggeredBroadcastData() has already been called
        ...
        virtual void setAtsEventType(ta_uint32 eventType);
        virtual void setLocationKey(ta_uint32 locationKey);
        virtual void setDestinationLocationKey(ta_uint32 key);
        virtual void setPlatformId(ta_uint32 platformId);
        virtual void setIsLastTrain(bool isEnabled);
        virtual void setPaZoneGroupKey(ta_uint32 key);
        virtual void setPaDvaMessageKey(ta_uint32 key);
       ...
       /**
         ...
         */
        virtual void updatePaAtsTriggeredBroadcastChanges(const std::string& name, const ta_uint32 oldValue, const ta_uint32 newValue);
        ...
        ta_uint32 m_uniqueIdentifier; // We cannot use keys for identification of PaAtsTriggeredBroadcasts in the
