...
namespace TA_IRS_Core
{
    ...
    IPaDvaMessageVersion* PaDvaMessageVersionAccessFactory::getPaDvaMessageVersionByLocationKey(const ta_uint32 locationKey,const bool readWrite)
    {
        return getPaDvaMessageVersionUsing(LOCATIONKEY_COL, locationKey, readWrite);
    }


    IPaDvaMessageVersion* PaDvaMessageVersionAccessFactory::getPaDvaMessageVersion(const ta_uint32 key,const bool readWrite)
    {
                                                                                            ...
                                                                                            bool readWrite)
    {
        ...
        ta_uint32 key = data->getUnsignedLongData(0, KEY_COL);
