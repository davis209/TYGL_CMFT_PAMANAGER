...
{
    ta_int32 ConfigPaTrainDvaMessage::s_nextAvailableIdentifier = 0;
    ...
    ConfigPaTrainDvaMessage::ConfigPaTrainDvaMessage(ta_uint32 row, TA_Base_Core::IData& data)
    ...
    ConfigPaTrainDvaMessage::ConfigPaTrainDvaMessage(const ta_uint32 key)
    ...
    ta_uint32 ConfigPaTrainDvaMessage::getKey()
    {
        TA_ASSERT(m_paTrainDvaMessageHelper != NULL,"The PaTrainDvaMessageHelper pointer is null.");
    ...
    void ConfigPaTrainDvaMessage::updatePaTrainDvaMessageChanges(const std::string& name, const ta_uint32 oldValue, const ta_uint32 newValue)
    {
    ...
    void ConfigPaTrainDvaMessage::setKeyForNewMessage(ta_uint32 key)
    {
        TA_ASSERT(m_paTrainDvaMessageHelper != NULL,"The m_paTrainDvaMessageHelper pointer is null.");
    ...
    void ConfigPaTrainDvaMessage::setKey(ta_uint32 key)
    {
    ...
    ta_uint32 ConfigPaTrainDvaMessage::getModifiedKey()
    {
        TA_ASSERT(m_paTrainDvaMessageHelper != NULL,"The m_paTrainDvaMessageHelper pointer is null.");        
