...
* 
*/
ITcpMethod::ITcpMethod(ta_uint32 methodLength, ta_uint32 methodHeaderLength,
...
ta_uint32 ITcpMethod::getMessageDataSize() const
{
...
void ITcpMethod::setParameterLong(unsigned int position, ta_uint32 value)
{
...
void ITcpMethod::setLong(unsigned int position, ta_uint32 value)
{
