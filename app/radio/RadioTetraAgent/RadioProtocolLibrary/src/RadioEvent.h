...
namespace TA_IRS_App
{
	...
	public:
		...
		typedef ta_uint32    SessionRefType;
		typedef ta_uint32    TransactionIDType;
		typedef          ta_int32   StatusType;
	...
	public:
		...
		*/
		virtual ta_uint32 getEventLength() const;
		/**
		* Return the specified length of the message header
		*/
		virtual ta_uint32 getEventHeaderLength() const;
		/**
		...
		*/
		virtual RadioEventReader* getEventReader();
	...
	protected:
		void fixIncomingSDSEventBuffer(size_t toSize);
