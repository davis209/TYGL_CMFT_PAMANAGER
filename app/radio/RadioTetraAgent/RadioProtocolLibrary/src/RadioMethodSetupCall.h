...
namespace TA_IRS_App
{
	...
	class RadioMethodSetupCall : public RadioMethodCallReference
	{
		...
		public:
			...
			enum ECallType {SINGLE_CALL,GROUP_UNACKNOWLEDGE,GROUP_ACKNOWLEDGE,BROADCAST, CIRCUITMODEDATA, AMBIENT_LISTENING};
		...
		public:
			...
			void setEncriptionFlag(bool on=true);
			void setSlotPerFrame(SLotPerFrame sf);
		private:
