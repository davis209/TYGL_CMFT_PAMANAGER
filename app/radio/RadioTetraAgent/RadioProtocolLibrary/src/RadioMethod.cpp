...
* 
*/
RadioMethod::RadioMethod(unsigned int methodLength, ta_uint32 methodType,RadioSessionReference SessionRef)
...
void RadioMethod::setTransactionId(ta_uint32 transactionId)
{
	setLong(METHOD_HEADER_TRANSACTION_ID_START_POSITION,transactionId);
}


ta_uint32 RadioMethod::getMethodHeaderLength() const
{
...
ta_uint32 RadioMethod::getShortStringLength() const
{
...
RadioMethod::EventType RadioMethod::getEventType() const
{
