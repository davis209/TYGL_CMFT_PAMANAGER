...
namespace TA_IRS_App
{
	...
	public:
		...
		*/
		virtual ta_uint32 getEventLength() const = 0;
		/**
		* Return the specified length of the message header
		*/
		virtual ta_uint32 getEventHeaderLength() const = 0;
		...
		*/
		ta_uint32 getParameterLength() const;
	...
	protected:
		...
		*/
		ta_uint32 getCurrentLength() const;

		/**
		* Access the local buffer
		*/
		void writeBufferLong(unsigned int position, ta_uint32 value);
		ta_uint32   readBufferLong(unsigned int position) const;
