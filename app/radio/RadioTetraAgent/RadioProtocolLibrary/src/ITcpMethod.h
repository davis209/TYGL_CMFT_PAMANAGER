...
namespace TA_IRS_App
{
	class ITcpMethod
	{
		...
		protected:
			...
			*
			*/
			ITcpMethod(ta_uint32 methodLength, ta_uint32 methodHeaderLength,
				ta_uint32 methodHeaderLengthStartPosition);
		...
		public:
			...
			ta_uint32 getMessageDataSize() const;
			...
			*/
			virtual ta_uint32 getMethodHeaderLength() const = 0;
			/**
			...
			* Return the specified length of the message header
			*/
			virtual ta_uint32 getShortStringLength() const = 0;
		...
		protected:
			...
			void setParameterLong(unsigned int position, ta_uint32 value);
			...
			*/
			...
			void setLong(unsigned int position, ta_uint32 value);
