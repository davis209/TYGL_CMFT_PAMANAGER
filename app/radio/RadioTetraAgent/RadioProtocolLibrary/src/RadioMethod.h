...
namespace TA_IRS_App
{
	class RadioMethod : public ITcpMethod
	{
		public:
			...
			typedef ta_uint32 RadioSessionReference;

		protected:

			RadioMethod(unsigned int methodLength, ta_uint32 methodType, RadioSessionReference SessionRef);
		...
		public:
			...
			void setTransactionId(ta_uint32 transactionId);
			/**
			* Return the specified length of the message header
			*/
			virtual ta_uint32 getMethodHeaderLength() const;
			/**
			...
			* Return the specified length of the message header
			*/
			virtual ta_uint32 getShortStringLength() const;
