...
ta_uint32 ITcpEvent::getParameterLong(unsigned int position) const
{
...
*/
ta_uint32 ITcpEvent::getParameterLength() const
{
...
*/
ta_uint32 ITcpEvent::getCurrentLength() const
{
	FUNCTION_ENTRY("getCurrentLength");
	ta_uint32 value = m_buffer.size();
	FUNCTION_EXIT;
	return value;
}
...
/**
* Write a ta_int32 value to the buffer.  Ensure written as little endian, to make compatible with read function.
*/
void ITcpEvent::writeBufferLong(unsigned int position, ta_uint32 value)
{
...
/**
* Read a ta_int32 value from the buffer.  Ensure read as little endian.
*/
ta_uint32 ITcpEvent::readBufferLong(unsigned int position) const
{
