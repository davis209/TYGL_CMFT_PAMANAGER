...
namespace TA_IRS_App
{
	...
	{
		public:
			RadioSessionException(const std::string& errorText, ta_int32 errorNumber) throw();
			virtual ~RadioSessionException() throw();

            ta_int32 getErrorNumber() const;

		private:

			ta_int32   m_errorNumber;
	};

    inline ta_int32 RadioSessionException::getErrorNumber() const
    {
