...
namespace TA_IRS_App
{
    ...
    class RadioTCPConnection : public TA_Base_Core::ISocketObserver,public TA_Base_Core::Thread
    {
        ...
        * @param    method
        */
        void Send(const ITcpMethod& method, ta_uint32 transactionId);
		...
		void setCheckConnection(bool bForceRestart = false);
        /**
		...
		inline void setOperationMode(TA_Base_Core::EOperationMode operationMode)
