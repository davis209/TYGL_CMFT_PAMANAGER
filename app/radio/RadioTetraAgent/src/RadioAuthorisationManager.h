...
namespace TA_IRS_App
{
	...
	class RadioAuthorisationManager : TA_Base_Core::Thread
	{
		...
		public:
			...
			* @param   AuthorisationStack    Reference to list to contain details
			*/
			bool cancelRequest(CADReference callID);
		...
		private:
			 ...
			 */
			std::string queryResults(ta_uint32 sessionRef, ta_uint32 resultRef, 
			 ...
			 */
			typedef std::map<CADReference, TA_IRS_App::AuthorisationRequestType> T_AuthRequestMap;
			T_AuthRequestMap m_radioAuthorisationStack;
