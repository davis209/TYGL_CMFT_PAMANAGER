...
namespace TA_IRS_App
{
	...
	{
		public:
			RadioEventSubscriber(RadioSessionServant& radioSessionServant, ta_uint32 consoleID, ta_uint32 locationKey,
		...
		public:
			virtual void sessionBegin( const std::string& session, ta_uint32 user,
			                       ta_uint32 profile, ta_uint32 location,
								   ta_uint32 workstation );
			virtual void sessionEnd( const std::string& session );
	
			void setCurrentSessionID(const std::string& session );
		private:
